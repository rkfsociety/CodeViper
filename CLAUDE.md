...
- **После коммита с пользовательской фичей — проверить `README.md`**: вводный абзац, быстрый старт, «Примеры запросов», счётчик задач ROADMAP, блоки MCP/P2P/память/автообновление.
