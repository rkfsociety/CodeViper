...
- fix: зависание при вводе текста — не строить превью контекста на каждый символ, изолировать список сообщений от поля ввода
- fix: «Electron не отвечает» при старте — превью контекста только по клику на ◎, лёгкий режим без скана проекта, лимит GPU-пересоздания окна
...
- perf: батчинг эмбеддингов до 4 запросов через Promise.all в embeddingQueue.ts
