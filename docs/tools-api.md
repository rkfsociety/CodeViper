...
РћС‚С‡С‘С‚ Рѕ РЅРµРєРѕСЂСЂРµРєС‚РЅС‹С… РїР°СЂР°РјРµС‚СЂР°С… РёРЅРґРµРєСЃР°С†РёРё: chunk size, overlap Рё batch РІ `settings.ts` Рё RAG-С„Р°Р№Р»Р°С… (`rag.ts`, `contextRAG.ts`, `embeddingQueue.ts`). Р’РѕР·РІСЂР°С‰Р°РµС‚ С‡РёС‚Р°РµРјС‹Р№ Markdown-РѕС‚С‡С‘С‚ РІ С‡Р°С‚.
