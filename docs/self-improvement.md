...
- **Сквозная нумерация** 1…N по всему разделу; после выполнения — удалить из `ROADMAP.md`, перенумеровать с 1, запись в [ROADMAP_DONE.md](../ROADMAP_DONE.md).
...
5. Пункт удалён из `ROADMAP.md`, запись в `ROADMAP_DONE.md`; автопуш в ветку `agent/self-improve`
