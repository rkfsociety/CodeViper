...
**Основная документация — [вики проекта](https://github.com/rkfsociety/CodeViper/wiki).**  
Здесь — только то, что привязано к git: GIF, промпты для агента, API инструментов, collective, CI.
