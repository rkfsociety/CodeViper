...
- `set_self_improvement_plan`: алиасы title/item/name; Gemini — минимальные JSON-схемы tools (fix #19); маркированный список вместо JSON + AUTO вместо ANY при >40 tools (fix #20)
