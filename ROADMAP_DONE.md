...
- `set_self_improvement_plan`: алиасы title/item/name; action/check (ROADMAP, fix #23); `complete_self_improvement_item` — числовой id; Gemini — минимальные JSON-схемы tools (fix #19); маркированный список вместо JSON + AUTO вместо ANY при >40 tools (fix #20)
