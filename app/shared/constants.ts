// ── Агент: шаги ──────────────────────────────────────────────────────────────
/** Число шагов агента по умолчанию; ограничивает бесконечные циклы */
export const DEFAULT_MAX_STEPS = 12
/** Минимальное допустимое значение maxSteps в настройках */
export const MAX_STEPS_MIN = 3
/** Максимальное допустимое значение maxSteps в настройках */
export const MAX_STEPS_MAX = 30

// ── Агент: прогоны в час ──────────────────────────────────────────────────────
/** Лимит прогонов агента за последние 60 минут по умолчанию */
