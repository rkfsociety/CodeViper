// ── Агент: шаги ──────────────────────────────────────────────────────────────
/** Число шагов агента по умолчанию (для сложных задач может быть больше) */
export const DEFAULT_MAX_STEPS = 50
/** Минимальное допустимое значение maxSteps в настройках */
export const MAX_STEPS_MIN = 1
/** Максимальное допустимое значение maxSteps в настройках (практически неограниченно) */
export const MAX_STEPS_MAX = 999
/** Лимит повторений одного инструмента подряд (защита от циклов) */
export const MAX_CONSECUTIVE_SAME_TOOL = 5
/** Лимит повторений одного инструмента в сессии (защита от циклов) */
export const MAX_SAME_TOOL_TOTAL = 15
