...
export const CREATE_MISSING_CONTENT_HINT = `create_* / write_* требуют path и content (полное содержимое). Сначала read_codeviper_file эталон из той же папки, затем create_codeviper_file с готовым кодом.`
