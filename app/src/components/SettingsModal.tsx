                  ...
                  <>
                          ...
                          <label>
                            ...
                            <div className="settings-api-key-row">
                              <input
                                ...
                                onChange={(e) =>
                                  onSettingsChange({ deepseekApiKey: e.target.value })
                                }
                                autoComplete="off"
                              />
                              <button
                    ...
                    {provider === 'anthropic' && (
                      ...
                      >
                        <>
                          <div className={styles.hint}>
                            Используется <strong>Claude API (Anthropic)</strong>. Модель по
                            умолчанию: <code>claude-3-5-sonnet-20241022</code>.
                          </div>
                          <label>
                            Claude API ключ
                            <div className="settings-api-key-row">
                    ...
                    {provider === 'together' && (
                      ...
                      >
                        <>
                          <div className={styles.hint}>
                            <strong>Together AI</strong> — облачный инференс с OpenAI-совместимым
                            API. Модель по умолчанию:{' '}
                          ...
                          <label>
                            ...
                            <div className="settings-api-key-row">
                              <input
                                ...
                                onChange={(e) =>
                                  onSettingsChange({ togetherApiKey: e.target.value })
                                }
                                autoComplete="off"
                              />
                              <button
                    ...
                    {settings.modelProvider === 'ollama' && (
                      ...
                      >
                        <label className={styles.toggle}>
                          ...
                          />
                          <span>
                            <strong>Автовыбор модели</strong> — подбирать модель под задачу,
                            выгружать другие из RAM (если установлено несколько)
                          </span>
                        </label>
                      </SettingItem>
                    )}
                        ...
                        >
                          {(
                            ...
                            const current = settings.aggressiveCompression
                              ...
                              : (settings.contextSummarizeThreshold ?? 85)
                            const active =
                              !settings.aggressiveCompression && current === preset.value
                            return (
                              <button
                                key={preset.value}
                                type="button"
                                ...
                                style={{
                                  ...
                                  fontSize: '0.78em',
                                  cursor: settings.aggressiveCompression
                                    ? 'not-allowed'
                                    : 'pointer',
                                  borderRadius: '4px',
                                  border: active
                      ...
                      <label className={styles.toggle}>
                        ...
                        <span className={styles.toggleContent}>
                          ...
                          <span className={styles.desc}>
                            Суммаризировать при 65% заполнения контекста — экономия 30–40% на
                            длинных диалогах; перекрывает слайдер выше
                          </span>
                        </span>
                      </label>
                    </SettingItem>
                            ...
                            {(settings.cloudProvider ?? 'deepseek') === 'deepseek' ? (
                              ...
                              <label>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    onSettingsChange({ cloudBaseUrl: e.target.value })
                                  }
                                />
                              </label>
                            )}
                  ...
                  <>
                      ...
                      <div className={styles.section}>
                        ...
                        <label className={styles.toggle}>
                          ...
                          <span className={styles.toggleContent}>
                            ...
                            <span className={styles.desc}>
                              Для think-моделей (qwen3, deepseek-r1, qwq) включает режим
                              рассуждения, для остальных усиливает промпт. Точнее, но медленнее
                            </span>
                          </span>
                        </label>
                        ...
                        <label className={styles.toggle}>
                          ...
                          <span className={styles.toggleContent}>
                            ...
                            <span className={styles.desc}>
                              ...
                              контекста. Экономит 20–50% токенов для think-моделей (DeepSeek-R1,
                              QwQ, Qwen3)
                            </span>
                          </span>
                        </label>
                      ...
                      <div className={styles.section}>
                        ...
                        <label className={styles.toggle}>
                          <input
                            ...
                            onChange={(e) =>
                              onSettingsChange({
                                autoVerifyAfterEdit: e.target.checked || undefined
                              })
                            }
                          />
                          <span className={styles.track} aria-hidden="true">
                        ...
                        {settings.gitSyncOnStartup !== false && (
                          <>
                            ...
                            <div className={`${styles.hint} ${styles.hintInline}`}>
                              ...
                              <code>git stash</code>, затем <code>reset --hard</code> на версию
                              GitHub (приоритет у GitHub). <strong>Rebase</strong> — локальные
                              коммиты переносятся поверх версии GitHub.{' '}
                              <strong>Fast-forward only</strong> — обновление только если нет
                              расхождений; иначе остаётся локальная версия (ничего не теряется).
                              <br />
                              При незакоммиченных изменениях лаунчер покажет предупреждение и
                              спросит подтверждение перед синхронизацией.
                            </div>
                          </>
                        )}
                      </div>
                    ...
                    >
                      <div className={styles.section}>
                        ...
                        <div className={`${styles.hint} ${styles.hintInline}`}>
                          Абсолютный путь к папке <code>app/</code> исходников CodeViper. Если
                          указан, используется вместо автоматического поиска. Оставьте пусто для
                ...
                {!isSearching && tab === 'model' && (
                  <>
                    {provider === 'ollama' ? (
                      ...
                      (settings.geminiTier ?? 'free') === 'free' ? null : (
                      <CloudModelSelector
                        provider={provider}
                        model={settings.model}
                      ...
                      <div className={styles.section}>
                        ...
                        <label className={styles.toggle}>
                          <input
                            ...
                            onChange={(e) =>
                              onSettingsChange({ prManualRefresh: e.target.checked })
                            }
                          />
                          <span className={styles.track} aria-hidden="true">
                            <span className={styles.thumb} />
                          ...
                          <span className={styles.toggleContent}>
                            ...
                            <span className={styles.desc}>
                              Отключает авто-опрос Pull Requests каждые 5 минут — обновление только
                              по кнопке
                            </span>
                          </span>
                        </label>
                      ...
                      <div className={styles.section}>
                        ...
                        <div className={styles.row}>
                          <div className={styles.rowContent}>
                            ...
                            <span className={styles.desc}>
                              Сколько слоёв модели загружать на GPU. Пусто или -1 — авто (всё на
                              GPU). 0 — только CPU (медленно, но без OOM). Дробные значения,
                              например 20, позволяют запустить крупную модель частично: одни слои на
                              GPU, остальные на RAM.
                            </span>
                          </div>
                          ...
                          <>
                            ...
                            <label>
                              ...
                              <div className="settings-api-key-row">
                                <input
                                  ...
                                  onChange={(e) =>
                                    onSettingsChange({ qdrantApiKey: e.target.value })
                                  }
                                  autoComplete="off"
                                />
                                <button
                            ...
                            <label className={styles.toggle}>
                              <input
                                ...
                                onChange={(e) =>
                                  onSettingsChange({
                                    autoIndexOnOpen: e.target.checked || undefined
                                  })
                                }
                              />
                              <span className={styles.track} aria-hidden="true">
                            ...
                            <label>
                              ...
                              <div className="settings-api-key-row">
                                <input
                                  ...
                                  onChange={(e) =>
                                    onSettingsChange({ milvusApiKey: e.target.value })
                                  }
                                  autoComplete="off"
                                />
                                <button
                    ...
                    >
                      <div className={styles.section}>
                        ...
                        <div className={`${styles.hint} ${styles.hintInline}`}>
                          ...
                          {!settings.p2pConsentGiven && (
                            <> При первом включении потребуется подтверждение.</>
                          )}
                        </div>
                        <label>
