...
Accessibility: Settings -> Performance -> High contrast mode makes panel/button borders and focus outlines stronger for low-vision users.
...
| [API (TypeDoc)](https://rkfsociety.github.io/CodeViper/) | [ROADMAP](ROADMAP.md) (463 пунктов, 13 файлов в `ROADMAP/`) · [Сделано](ROADMAP_DONE.md) |
...
`find_p2p_credit_issues` checks `server/p2p/src/credits.ts` for invalid P2P credit limits and reads the live credits store when the P2P endpoint is configured.
