...
| ☁️ **Облачные модели** | DeepSeek, OpenAI, Anthropic Claude, Google Gemini (free/paid), OpenRouter (400+ моделей) |
| 🛠 **Инструменты агента** | Чтение/запись/поиск файлов, точечные правки с diff, grep, терминал, git, GitHub Issues/PR |
...
| 🔒 **Режимы доступа** | Спрашивать всё / принимать правки / полный автопилот (bypass) |
...
Рекомендуемые локальные модели (минимум 7b): `qwen2.5-coder:7b`, `qwen3:8b`, `deepseek-coder-v2:16b`.
...
| Gemini | `AIza...` | Gemini 2.5/3.x, thinking, free tier с лимитами RPM/TPM |
