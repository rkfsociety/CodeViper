...
**2 · M · Рейтинг знаний collective** — приор. Low  
...
**3 · S · Экспорт урока в skill** — приор. Medium  
...
**4 · M · Контракт subagent** — приор. Medium  
...
**5 · L · Explorer subagent** — приор. Medium  
...
**6 · L · Editor subagent в цикле** — приор. Low  
...
**7 · S · Каналы обновлений stable/beta** — приор. Low  
...
**8 · L · Песочница для run_script** — приор. Medium  
...
**12 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**13 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**14 · M · Счётчик стоимости облачных запросов** — приор. Medium  
