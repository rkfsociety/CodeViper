...
**Правила:** пункты **1…127**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **1…127**. Цепочки 🔗 — строгий порядок внутри группы: split/preview (готово), plan **10–11**, onboarding **12–14**, редактор **41–42**, worktree **46–48**, LSP **70–72**, i18n **125–128**.
...
**1 · S · Автосохранение черновика ввода** — уровень 2
...
**2 · S · Сохранение светлой темы в settings** — уровень 2
...
**3 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**4 · S · Ctrl+` — переключить терминал** — уровень 2
...
**5 · M · Недавние проекты** — уровень 2
...
**6 · M · planBeforeExecute в настройках** — уровень 2
...
**7 · M · Пауза после плана до подтверждения** — уровень 2
...
**8 · M · Флаг firstRunCompleted** — уровень 2
...
**9 · M · OnboardingWizard** — уровень 2
...
**10 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**11 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**12 · M · Цепочка fallback моделей** — уровень 2
...
**13 · S · Чип прогресса индексации** — уровень 2
...
**14 · S · Ручная переиндексация** — уровень 2
...
**15 · M · Аудит focus trap в модалках** — уровень 2
...
**16 · S · aria-live для статуса агента** — уровень 2
...
**17 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**18 · S · Подтверждение внешних ссылок** — уровень 2
...
**19 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**20 · M · Субагент Reviewer** — уровень 2
...
**21 · M · Субагент Tester** — уровень 2
...
**22 · M · git_blame и git_show** — уровень 2
...
**25 · M · npm_install / add_package** — уровень 2
...
**26 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**27 · M · E2E: smoke настройки и отправка** — уровень 2
...
**28 · M · Component test MessageRow** — уровень 2
...
**29 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**30 · S · docs/troubleshooting.md** — уровень 2
...
**31 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**32 · M · ModelTab: формы провайдеров** — уровень 2
...
**33 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**34 · M · Экспорт чата в Markdown** — уровень 2
...
**35 · M · IPC export-chat** — уровень 2
...
**36 · M · IPC import-chat** — уровень 2
...
**37 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**38 · M · Сохранение из редактора** — уровень 2
...
**39 · M · find_symbol для Go** — уровень 3
...
**40 · M · find_symbol для Rust** — уровень 3
...
**41 · M · find_symbol для Java** — уровень 3
...
**43 · M · worktreePath в чате + IPC** — уровень 3
...
**44 · M · AgentRunner — корень worktree** — уровень 3
...
**45 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**46 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**47 · M · services.ts: файловые операции** — уровень 3
...
**48 · M · services.ts: runCommand** — уровень 3
...
**58 · S · Skip link «К содержимому»** — уровень 3
...
**59 · S · Экспорт метрик в CSV** — уровень 3
...
**60 · S · Документация plugin-authoring** — уровень 3
...
**61 · M · Провайдер Mistral** — уровень 3
...
**62 · M · Bitbucket: create_pull_request** — уровень 3
...
**63 · M · Azure DevOps: create_work_item** — уровень 3
...
**64 · S · Discord webhook** — уровень 3
...
**65 · S · Telegram Bot уведомления** — уровень 3
...
**66 · M · lspClient — spawn language server** — уровень 3
...
**67 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**68 · M · LSP pyright для Python** — уровень 3
...
**69 · M · Fetch remote skill manifest** — уровень 3
...
**70 · M · import-remote-skill UI** — уровень 3
...
**71 · M · AutomationRule в settings** — уровень 3
...
**72 · M · automationScheduler в main** — уровень 3
...
**73 · M · AutomationsTab в настройках** — уровень 3
...
**74 · M · Дублировать промпт во второй чат** — уровень 3
...
**76 · M · docker-compose для server/p2p** — уровень 3
...
**77 · M · Dashboard статуса узлов** — уровень 3
...
**78 · M · Рейтинг узлов по latency** — уровень 3
...
**84 · M · STT — кнопка микрофона** — уровень 4
...
**85 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**86 · M · Разбивка App.tsx** — уровень 4
...
**87 · M · Разбивка agent.ts** — уровень 4
...
**88 · M · Хук useChatPanelState** — уровень 4
...
**89 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**90 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**91 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**92 · M · types.ts: доменные модули** — уровень 4
...
**93 · M · agentContext: RAG-hints** — уровень 4
...
**94 · M · agentContext: preview и prepare** — уровень 4
...
**95 · M · useAgentStream: обработчики событий** — уровень 4
...
**96 · M · preload: группы API** — уровень 4
...
**97 · M · agentTools/core: files / git / package** — уровень 4
...
**98 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**99 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**111 · S · Цвет папки чатов** — уровень 4
...
**112 · M · Drag-drop папок в чат** — уровень 4
...
**113 · M · Mermaid в ответах агента** — уровень 4
...
**121 · L · Открепить чат в отдельное окно** — уровень 4
...
**122 · M · Инфраструктура i18n** — уровень 4
...
**123 · M · Переключатель языка в настройках** — уровень 4
...
**124 · M · i18n: строки App и шапки** — уровень 4
...
**125 · M · i18n: SettingsModal** — уровень 4
...
**126 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**127 · M · Docker dev-окружение** — уровень 4
