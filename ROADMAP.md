...
> Нумерация сквозная **1…13**. Сложность: S / M / L / XL. Приоритет указан в конце пункта. Пустые категории без пунктов не держим — выполненные цепочки (P2P, базовое коллективное обучение) см. в «✅ Сделано».
...
**6 · L · Vision-ввод (скриншоты в чат)** — приор. Medium  
...
**7 · M · Библиотека промптов / слэш-шаблоны** — приор. Low  
...
**8 · M · Повтор прогона с шага из TracePanel** — приор. Low  
...
**9 · M · Дашборд метрик агента** — приор. Low  
...
**11 · L · Встроенный редактор кода (Monaco/CodeMirror)** — приор. Low  
...
**12 · XL · LSP в редакторе** — приор. Low  
...
**13 · L · Skill marketplace** — приор. Low  
