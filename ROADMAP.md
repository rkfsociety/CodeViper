...
**Правила:** нумерация сквозная (1…23); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
**3 · M · typedoc + GitHub Pages** — приор. Low  
...
**4 · S · Nudge «используй RAG»** — приор. Medium  
...
**5 · L · Символьный индекс (find_symbol)** — приор. High  
...
**6 · M · Дерево файлов проекта** — приор. High  
...
**7 · M · Side-by-side diff** — приор. Medium  
...
**8 · S · Уведомление «агент закончил»** — приор. Medium  
...
**9 · M · Шаблоны чатов** — приор. Medium  
...
**10 · M · Авто-PR collective** — приор. Medium  
...
**11 · M · Рейтинг знаний collective** — приор. Low  
...
**12 · S · Экспорт урока в skill** — приор. Medium  
...
**13 · M · Контракт subagent** — приор. Medium  
...
**14 · L · Explorer subagent** — приор. Medium  
...
**15 · L · Editor subagent в цикле** — приор. Low  
...
**16 · S · Каналы обновлений stable/beta** — приор. Low  
...
**17 · L · Песочница для run_script** — приор. Medium  
...
**18 · L · Голосовой ввод и озвучка** — приор. Low  
...
**19 · XL · LSP в редакторе** — приор. Low  
...
**20 · L · Skill marketplace** — приор. Low  
...
**21 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**22 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**23 · M · Счётчик стоимости облачных запросов** — приор. Medium  
