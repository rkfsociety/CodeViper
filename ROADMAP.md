...
**1 · S · UI секция «Оркестратор»** — приор. Low  
...
**2 · M · Интеграция в AgentRunner** — приор. Low  
...
**3 · XL · REST API сигнального сервера** — приор. Low  
...
**4 · XL · Auth на сигнальном сервере** — приор. Low  
...
**5 · M · Тумблер «Поделиться мощностью»** — приор. Low  
...
**6 · S · Диалог согласия P2P** — приор. Low  
...
**7 · M · Пауза P2P при нагрузке** — приор. Low  
...
**8 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**9 · M · TLS + шифрование промптов** — приор. Low  
...
**10 · L · Маршрутизация задач на сервере** — приор. Low  
...
**11 · L · Кредиты P2P в UI** — приор. Low  
...
**12 · M · Docker dev-окружение** — приор. Low  
...
**15 · M · CONTRIBUTING.md** — приор. Low  
...
**16 · M · typedoc + GitHub Pages** — приор. Low  
...
**17 · S · Nudge «используй RAG»** — приор. Medium  
...
**18 · L · Символьный индекс (find_symbol)** — приор. Medium  
...
**19 · M · Дерево файлов проекта** — приор. High  
...
**20 · M · Side-by-side diff** — приор. Medium  
...
**21 · S · Уведомление «агент закончил»** — приор. Medium  
...
**22 · M · Шаблоны чатов** — приор. Medium  
...
**23 · M · Авто-PR collective** — приор. Medium  
...
**24 · M · Рейтинг знаний collective** — приор. Low  
...
**25 · S · Экспорт урока в skill** — приор. Medium  
...
**26 · M · Контракт subagent** — приор. Medium  
...
**27 · L · Explorer subagent** — приор. Medium  
...
**28 · L · Editor subagent в цикле** — приор. Low  
...
**29 · S · Каналы обновлений stable/beta** — приор. Low  
...
**30 · L · Песочница для run_script** — приор. Low  
...
**31 · L · Голосовой ввод и озвучка** — приор. Low  
...
**32 · XL · LSP в редакторе** — приор. Low  
...
**33 · L · Skill marketplace** — приор. Low  
...
**34 · M · E2E на Linux/macOS в CI** — приор. Medium  
