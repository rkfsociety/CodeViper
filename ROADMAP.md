...
> **Принцип чтения:** **Блок 0 выполнен** — live runtime с GitHub. Дальше «📋 В планах» (3…142); внутри цепочки 🔗 — строгий порядок.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 3…142
...
**Правила:** пункты **3…142**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **3…142** (140 задач). Цепочки 🔗 — строгий порядок внутри группы: roadmap/github **3–7**, split/preview **10–12**, plan **21–22**, onboarding **23–25**, редактор **52–53**, worktree **57–59**, LSP **81–83**, i18n **137–141**.
...
**5 · S · read_roadmap_item** — уровень 1
...
**6 · S · Описания search-инструментов** — уровень 1
...
**7 · M · docs/tools-api актуализация** — уровень 1
...
> Ежедневный UX, превью файлов, onboarding, провайдеры, субагенты, E2E, ModelTab. Пункты **8–53** — выполнять сверху вниз; цепочки см. шапку раздела.

**8 · S · Toast при ожидании подтверждения** — уровень 2
...
**9 · M · Расширение горячих клавиш** — уровень 2
...
**10 · M · Resizable split layout** — уровень 2
...
**11 · M · FilePreviewPanel read-only** — уровень 2
...
**12 · S · ProjectTree открывает превью** — уровень 2
...
**13 · S · Копировать блок кода в MessageBody** — уровень 2
...
**14 · M · Повторить ответ ассистента** — уровень 2
...
**15 · S · Поиск по истории чатов** — уровень 2
...
**16 · S · Автосохранение черновика ввода** — уровень 2
...
**17 · S · Сохранение светлой темы в settings** — уровень 2
...
**18 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**19 · S · Ctrl+` — переключить терминал** — уровень 2
...
**20 · M · Недавние проекты** — уровень 2
...
**21 · M · planBeforeExecute в настройках** — уровень 2
...
**22 · M · Пауза после плана до подтверждения** — уровень 2
...
**23 · M · Флаг firstRunCompleted** — уровень 2
...
**24 · M · OnboardingWizard** — уровень 2
...
**25 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**26 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**27 · M · Цепочка fallback моделей** — уровень 2
...
**28 · S · Чип прогресса индексации** — уровень 2
...
**29 · S · Ручная переиндексация** — уровень 2
...
**30 · M · Аудит focus trap в модалках** — уровень 2
...
**31 · S · aria-live для статуса агента** — уровень 2
...
**32 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**33 · S · Подтверждение внешних ссылок** — уровень 2
...
**34 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**35 · M · Субагент Reviewer** — уровень 2
...
**36 · M · Субагент Tester** — уровень 2
...
**37 · M · git_blame и git_show** — уровень 2
...
**40 · M · npm_install / add_package** — уровень 2
...
**41 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**42 · M · E2E: smoke настройки и отправка** — уровень 2
...
**43 · M · Component test MessageRow** — уровень 2
...
**44 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**45 · S · docs/troubleshooting.md** — уровень 2
...
**46 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**47 · M · ModelTab: формы провайдеров** — уровень 2
...
**48 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**49 · M · Экспорт чата в Markdown** — уровень 2
...
**50 · M · IPC export-chat** — уровень 2
...
**51 · M · IPC import-chat** — уровень 2
...
**52 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**53 · M · Сохранение из редактора** — уровень 2
...
> Символы, worktree, рефакторинг IPC/services, интеграции, LSP, автоматизации, P2P. Пункты **55–99**.

**54 · M · find_symbol для Go** — уровень 3
...
**55 · M · find_symbol для Rust** — уровень 3
...
**56 · M · find_symbol для Java** — уровень 3
...
**58 · M · worktreePath в чате + IPC** — уровень 3
...
**59 · M · AgentRunner — корень worktree** — уровень 3
...
**60 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**61 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**62 · M · services.ts: файловые операции** — уровень 3
...
**63 · M · services.ts: runCommand** — уровень 3
...
**73 · S · Skip link «К содержимому»** — уровень 3
...
**74 · S · Экспорт метрик в CSV** — уровень 3
...
**75 · S · Документация plugin-authoring** — уровень 3
...
**76 · M · Провайдер Mistral** — уровень 3
...
**77 · M · Bitbucket: create_pull_request** — уровень 3
...
**78 · M · Azure DevOps: create_work_item** — уровень 3
...
**79 · S · Discord webhook** — уровень 3
...
**80 · S · Telegram Bot уведомления** — уровень 3
...
**81 · M · lspClient — spawn language server** — уровень 3
...
**82 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**83 · M · LSP pyright для Python** — уровень 3
...
**84 · M · Fetch remote skill manifest** — уровень 3
...
**85 · M · import-remote-skill UI** — уровень 3
...
**86 · M · AutomationRule в settings** — уровень 3
...
**87 · M · automationScheduler в main** — уровень 3
...
**88 · M · AutomationsTab в настройках** — уровень 3
...
**89 · M · Дублировать промпт во второй чат** — уровень 3
...
**91 · M · docker-compose для server/p2p** — уровень 3
...
**92 · M · Dashboard статуса узлов** — уровень 3
...
**93 · M · Рейтинг узлов по latency** — уровень 3
...
> Голос, рефакторинг монолитов, i18n, Docker, polish. Пункты **100–143** — когда уровни 1–3 закрыты.

**99 · M · STT — кнопка микрофона** — уровень 4
...
**100 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**101 · M · Разбивка App.tsx** — уровень 4
...
**102 · M · Разбивка agent.ts** — уровень 4
...
**103 · M · Хук useChatPanelState** — уровень 4
...
**104 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**105 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**106 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**107 · M · types.ts: доменные модули** — уровень 4
...
**108 · M · agentContext: RAG-hints** — уровень 4
...
**109 · M · agentContext: preview и prepare** — уровень 4
...
**110 · M · useAgentStream: обработчики событий** — уровень 4
...
**111 · M · preload: группы API** — уровень 4
...
**112 · M · agentTools/core: files / git / package** — уровень 4
...
**113 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**114 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**126 · S · Цвет папки чатов** — уровень 4
...
**127 · M · Drag-drop папок в чат** — уровень 4
...
**128 · M · Mermaid в ответах агента** — уровень 4
...
**136 · L · Открепить чат в отдельное окно** — уровень 4
...
**137 · M · Инфраструктура i18n** — уровень 4
...
**138 · M · Переключатель языка в настройках** — уровень 4
...
**139 · M · i18n: строки App и шапки** — уровень 4
...
**140 · M · i18n: SettingsModal** — уровень 4
...
**141 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**142 · M · Docker dev-окружение** — уровень 4
...
- Инкрементальная индексация: `fs.watch` → debounce → upsert/delete чанков изменённого файла без full reindex
