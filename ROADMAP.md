...
> **Принцип чтения:** сначала **Блок 0 (пункты 1–7)** — live runtime с GitHub; только после него — «📋 В планах» (8…149). Внутри цепочки — строгий порядок.
...
**1 · S · Настройка liveRuntimeFromGit** — блок 0
...
**2 · M · Startup sync для packaged** — блок 0
...
**3 · M · Сборка runtime в клоне** — блок 0
...
**4 · L · Загрузка agent runtime из клона** — блок 0
...
**5 · M · Relaunch после обновления runtime** — блок 0
...
**6 · S · Документация live runtime** — блок 0
...
**7 · M · Тесты bundled source runtime** — блок 0
...
```text
N · [S/M/L/XL] · Краткое название — блок 0 | уровень 8…149
...
**Промпты:** блок 0 → `Выполни пункт N из ROADMAP.md — блок 0, live runtime.` · пункты 8+ → `Выполни пункт N из ROADMAP.md — самоулучшение CodeViper.`

**Правила:** блок **0 (1–7)** — первым; затем **8…149**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **8…149**. **Не начинать, пока блок 0 не в «✅ Сделано»** — иначе каждый фикс агента снова требует релиза.


### 🔴 Уровень 1 — критично (с пункта 8)

> **Цепочки:** ignore **8–9**, roadmap/github **10–14**, split-view **27–29**, onboarding **40–42**, редактор **64–65**, worktree **69–71**, LSP **93–95**, i18n **149–153**.
