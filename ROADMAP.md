...
**Правила:** пункты **1…530** выбираются **сначала по важности/нужности**, а **внутри важности — от лёгких к более сложным**; один пункт = один прогон самоулучшения.

## ?? В планах

> Пункты **1…530** — сгруппированы так, чтобы агент сначала брал **более нужные** задачи, а внутри выбранной группы шёл **от простого к сложному**. Внутри уровня S/M/L/XL — сначала уровень 2, затем 3, затем 4.
...
> Одна правка, 1–2 файла, быстрая проверка. Начинать с этих пунктов. Пункты **1–153**.
