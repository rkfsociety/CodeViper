...
**1 · M · Скачивание GGUF по умолчанию** — приор. Low  
...
**2 · S · UI секция «Оркестратор»** — приор. Low  
...
**3 · M · Интеграция в AgentRunner** — приор. Low  
...
**4 · XL · REST API сигнального сервера** — приор. Low  
...
**5 · XL · Auth на сигнальном сервере** — приор. Low  
...
**6 · M · Тумблер «Поделиться мощностью»** — приор. Low  
...
**7 · S · Диалог согласия P2P** — приор. Low  
...
**8 · M · Пауза P2P при нагрузке** — приор. Low  
...
**9 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**10 · M · TLS + шифрование промптов** — приор. Low  
...
**11 · L · Маршрутизация задач на сервере** — приор. Low  
...
**12 · L · Кредиты P2P в UI** — приор. Low  
...
**13 · M · Docker dev-окружение** — приор. Low  
...
**16 · M · CONTRIBUTING.md** — приор. Low  
...
**17 · M · typedoc + GitHub Pages** — приор. Low  
...
**18 · S · Nudge «используй RAG»** — приор. Medium  
...
**19 · L · Символьный индекс (find_symbol)** — приор. Medium  
...
**20 · M · Дерево файлов проекта** — приор. High  
...
**21 · M · Side-by-side diff** — приор. Medium  
...
**22 · S · Уведомление «агент закончил»** — приор. Medium  
...
**23 · M · Шаблоны чатов** — приор. Medium  
...
**24 · M · Авто-PR collective** — приор. Medium  
...
**25 · M · Рейтинг знаний collective** — приор. Low  
...
**26 · S · Экспорт урока в skill** — приор. Medium  
...
**27 · M · Контракт subagent** — приор. Medium  
...
**28 · L · Explorer subagent** — приор. Medium  
...
**29 · L · Editor subagent в цикле** — приор. Low  
...
**30 · S · Каналы обновлений stable/beta** — приор. Low  
...
**31 · L · Песочница для run_script** — приор. Low  
...
**32 · L · Голосовой ввод и озвучка** — приор. Low  
...
**33 · XL · LSP в редакторе** — приор. Low  
...
**34 · L · Skill marketplace** — приор. Low  
...
**35 · M · E2E на Linux/macOS в CI** — приор. Medium  
