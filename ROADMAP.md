...
**Правила:** пункты **1…520** выбираются **сначала по важности/нужности**, а **внутри важности — от лёгких к более сложным**; один пункт = один прогон самоулучшения.

## 📋 В планах

### 🟢 S — простые

> Одна правка, 1–2 файла, быстрая проверка. Начинать с этих пунктов. Пункты **1–143**.
...
**1 · S · Авто-форматирование проекта** — уровень 2
...
**10 · S · Skip link «К содержимому»** — уровень 3
...
**11 · S · Экспорт метрик в CSV** — уровень 3
...
**12 · S · Документация plugin-authoring** — уровень 3
...
**13 · S · Discord webhook** — уровень 3
...
**14 · S · Telegram Bot уведомления** — уровень 3
...
**18 · S · Авто-генерация диаграмм зависимостей** — уровень 3
...
**19 · S · Авто-генерация диаграмм классов** — уровень 3
...
**20 · S · Авто-генерация диаграмм потоков данных** — уровень 3
...
**21 · S · Авто-генерация метрик проекта** — уровень 3
...
**22 · S · Авто-обнаружение «мертвого кода»** — уровень 3
...
**23 · S · Авто-обнаружение «магических чисел»** — уровень 3
...
**24 · S · Авто-обнаружение небезопасных регулярных выражений** — уровень 3
...
**25 · S · Авто-обнаружение неправильных типов** — уровень 3
...
**26 · S · Авто-обнаружение неправильных импортов** — уровень 3
...
**27 · S · Авто-обнаружение неправильных hotkeys** — уровень 3
...
**28 · S · Авто-обнаружение «тяжёлых» зависимостей** — уровень 3
...
**29 · S · Авто-обнаружение пропущенных тестов** — уровень 3
...
**30 · S · Авто-обнаружение лишних ререндеров** — уровень 3
...
**31 · S · Авто-обнаружение неправильных путей в settings.json** — уровень 3
...
**32 · S · Авто-обнаружение неправильных aria-атрибутов** — уровень 3
...
**33 · S · Авто-обнаружение неправильных путей в интеграциях** — уровень 3
...
**34 · S · Авто-обнаружение неправильных cron-выражений** — уровень 3
...
**35 · S · Авто-обнаружение неправильных merge-конфликтов** — уровень 3
- **Цель:** поиск `<<<<<<<`
...
**36 · S · Авто-обнаружение неправильных commit-сообщений** — уровень 3
...
**37 · S · Авто-обнаружение неправильных Docker-портов** — уровень 3
...
**38 · S · Авто-обнаружение неправильных Docker-env** — уровень 3
- **Цель:** проверка env
- **Файлы:** `.env`
- **Действие:** анализ
- **Проверка:** отчёт
...
**39 · S · Авто-обнаружение неправильных P2P-кредитов** — уровень 3
...
**40 · S · Авто-обнаружение неправильных P2P-подключений** — уровень 3
- **Цель:** проверка WSS
- **Файлы:** `p2pClient.ts`
- **Действие:** анализ
- **Проверка:** отчёт
...
**41 · S · Авто-обнаружение неправильных skill-файлов** — уровень 3
...
**42 · S · Авто-обнаружение неправильных символьных индексов** — уровень 3
...
**43 · S · Авто-обнаружение неправильных prompt-templates** — уровень 3
...
**44 · S · Авто-обнаружение неправильных toast-уведомлений** — уровень 3
...
**45 · S · Авто-обнаружение неправильных environment-переменных** — уровень 3
- **Цель:** проверка `.env`
...
**46 · S · Авто-обнаружение неправильных моделей RAG** — уровень 3
...
**47 · S · Авто-обнаружение неправильных параметров индексации** — уровень 3
...
**48 · S · Авто-обнаружение неправильных настроек orchestrator** — уровень 3
...
**49 · S · Авто-обнаружение неправильных настроек Vision-моделей** — уровень 3
...
**50 · S · Авто-обнаружение неправильных настроек Explorer-субагента** — уровень 3
...
**51 · S · Авто-обнаружение неправильных настроек Reviewer-субагента** — уровень 3
...
**52 · S · Авто-обнаружение неправильных настроек Architect-субагента** — уровень 3
...
**53 · S · Авто-обнаружение неправильных настроек Performance-субагента** — уровень 3
...
**54 · S · Авто-обнаружение неправильных настроек collective memory** — уровень 3
...
**55 · S · Авто-обнаружение неправильных шаблонов чатов** — уровень 3
- **Цель:** проверка шаблонов
...
**56 · S · Авто-обнаружение неправильных split-layout настроек** — уровень 3
...
**57 · S · Авто-обнаружение неправильных quick-open результатов** — уровень 3
...
**58 · S · Авто-обнаружение неправильных code-editor настроек** — уровень 3
...
**59 · S · Авто-обнаружение неправильных MCP-серверов** — уровень 3
- **Цель:** проверка MCP
...
**60 · S · Авто-обнаружение неправильных enabledTools** — уровень 3
...
**61 · S · Авто-обнаружение неправильных tool-описаний** — уровень 3
...
**62 · S · Авто-обнаружение неправильных tool-параметров** — уровень 3
...
**63 · S · Авто-обнаружение неправильных tool-ошибок** — уровень 3
...
**64 · S · Авто-обнаружение неправильных tool-fallbacks** — уровень 3
...
**65 · S · Авто-обнаружение неправильных switch-конструкций** — уровень 3
...
**66 · S · Авто-обнаружение неправильных throw-выражений** — уровень 3
- **Цель:** проверка ошибок
- **Файлы:** `agentTools/core.ts`
...
**67 · S · Авто-обнаружение неправильных default-экспортов** — уровень 3
...
**68 · S · Авто-обнаружение неправильных import-alias** — уровень 3
- **Цель:** проверка alias
- **Файлы:** `symbolIndex.ts`
...
**69 · S · Авто-обнаружение неправильных путей в FilePreviewPanel** — уровень 3
...
**70 · S · Авто-обнаружение неправильных путей в ChatHistoryPanel** — уровень 3
...
**71 · S · Авто-обнаружение неправильных путей в TracePanel** — уровень 3
- **Цель:** проверка trace
...
**72 · S · Авто-обнаружение неправильных путей в TerminalPanel** — уровень 3
...
**73 · S · Авто-обнаружение неправильных путей в OnboardingWizard** — уровень 3
...
**74 · S · Авто-обнаружение неправильных путей в AutomationsTab** — уровень 3
...
**75 · S · Авто-обнаружение неправильных путей в BehaviorTab** — уровень 3
...
**76 · S · Авто-обнаружение неправильных путей в SkillsPanel** — уровень 3
...
**77 · S · Авто-обнаружение неправильных путей в SelfImprovePanel** — уровень 3
...
**78 · S · Авто-обнаружение неправильных путей в QueueContext** — уровень 3
...
**79 · S · Авто-обнаружение неправильных путей в agentContext** — уровень 3
...
**80 · S · Авто-обнаружение неправильных путей в agentHandlersProject** — уровень 3
...
**81 · S · Авто-обнаружение неправильных путей в modelRuntime** — уровень 3
...
**82 · S · Авто-обнаружение неправильных путей в commandRunner** — уровень 3
...
**83 · S · Авто-обнаружение неправильных путей в ipcContracts** — уровень 3
...
**84 · S · Авто-обнаружение неправильных путей в main/index.ts** — уровень 3
- **Цель:** проверка main
...
**85 · S · Режим высокой контрастности** — уровень 4
...
**86 · S · Цвет папки чатов** — уровень 4
...
**91 · S · Авто-озвучка ошибок агента** — уровень 4
...
**92 · S · Авто-озвучка успешного завершения** — уровень 4
...
**93 · S · Авто-публикация Docker-образов** — уровень 4
...
**94 · S · Авто-деплой на Vercel/Netlify** — уровень 4
...
**95 · S · Авто-генерация Helm-чартов** — уровень 4
...
**96 · S · Авто-генерация Ansible-ролей** — уровень 4
...
**97 · S · Авто-генерация GitHub Actions** — уровень 4
...
**98 · S · Авто-генерация GitLab CI** — уровень 4
...
**99 · S · Авто-генерация Azure Pipelines** — уровень 4
...
**100 · S · Авто-генерация Bitbucket Pipelines** — уровень 4
...
**101 · S · Авто-генерация аудио-версии CHANGELOG** — уровень 4
...
**102 · S · Авто-генерация GIF-демонстраций** — уровень 4
...
**103 · S · Авто-генерация UI-тестов** — уровень 4
...
**104 · S · Авто-генерация accessibility-отчётов** — уровень 4
...
**105 · S · Авто-генерация иконок** — уровень 4
...
**106 · S · Авто-генерация splash-screen** — уровень 4
...
**107 · S · Авто-генерация релизных баннеров** — уровень 4
...
**108 · S · Авто-генерация примеров для плагинов** — уровень 4
...
**109 · S · Авто-генерация FAQ** — уровень 4
...
**110 · S · Авто-генерация руководства разработчика** — уровень 4
...
**111 · S · Авто-генерация аудио-версии документации** — уровень 4
...
**112 · S · Авто-генерация аудио-версии ROADMAP** — уровень 4
...
**114 · S · Авто-генерация GIF-анимаций для README** — уровень 4
...
**115 · S · Авто-генерация баннеров релизов** — уровень 4
...
**116 · S · Авто-генерация иконок для плагинов** — уровень 4
...
**117 · S · Авто-генерация цветовых схем** — уровень 4
...
**118 · S · Авто-генерация шрифтовых схем** — уровень 4
...
**119 · S · Авто-генерация onboarding-гайдов** — уровень 4
...
**120 · S · Авто-генерация user-гайдов** — уровень 4
...
**121 · S · Авто-генерация документации по API субагентов** — уровень 4
...
**122 · S · Авто-генерация аудио-версии архитектурных отчётов** — уровень 4
...
**123 · S · Авто-генерация аудио-версии тестовых отчётов** — уровень 4
...
**124 · S · Авто-генерация аудио-версии UX-отчётов** — уровень 4
...
**125 · S · Авто-генерация GIF-анимаций архитектуры** — уровень 4
...
**126 · S · Авто-генерация баннеров для релизов** — уровень 4
...
**127 · S · Авто-генерация иконок для субагентов** — уровень 4
...
**128 · S · Авто-генерация цветовых схем для плагинов** — уровень 4
...
**129 · S · Авто-генерация шрифтовых схем для плагинов** — уровень 4
...
**130 · S · Авто-генерация onboarding-гайдов для плагинов** — уровень 4
...
**131 · S · Авто-генерация user-гайдов для плагинов** — уровень 4
...
**132 · S · Авто-генерация документации по API worktree** — уровень 4
...
**133 · S · Авто-генерация аудио-версии архитектурных диаграмм** — уровень 4
...
**134 · S · Авто-генерация аудио-версии потоковых диаграмм** — уровень 4
...
**135 · S · Авто-генерация аудио-версии отчётов по качеству** — уровень 4
...
**136 · S · Авто-генерация GIF-анимаций потоков данных** — уровень 4
...
**137 · S · Авто-генерация баннеров для архитектурных отчётов** — уровень 4
...
**138 · S · Авто-генерация иконок для архитектурных панелей** — уровень 4
...
**139 · S · Авто-генерация цветовых схем для архитектурных панелей** — уровень 4
...
**140 · S · Авто-генерация шрифтовых схем для архитектурных панелей** — уровень 4
...
**141 · S · Авто-генерация onboarding-гайдов для архитектурных панелей** — уровень 4
...
**142 · S · Авто-генерация user-гайдов для архитектурных панелей** — уровень 4
...
**143 · S · Авто-генерация документации по API потоковых диаграмм** — уровень 4
...
**144 · M · Аудит focus trap в модалках** — уровень 2
...
**145 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**146 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**147 · M · Субагент Reviewer** — уровень 2
...
**148 · M · Субагент Tester** — уровень 2
...
**149 · M · git_blame и git_show** — уровень 2
...
**151 · M · read_agent_log** — уровень 2
...
**152 · M · npm_install / add_package** — уровень 2
...
**153 · M · E2E: smoke настройки и отправка** — уровень 2
...
**154 · M · Component test MessageRow** — уровень 2
...
**155 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`
- **Проверка:** `npm run test:e2e`


**156 · M · ModelTab: формы провайдеров** — уровень 2
...
**157 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**158 · M · Экспорт чата в Markdown** — уровень 2
...
**159 · M · IPC export-chat** — уровень 2
...
**160 · M · IPC import-chat** — уровень 2
...
**161 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**162 · M · Сохранение из редактора** — уровень 2
...
**163 · M · Subagent Architect — анализ структуры проекта** — уровень 2
...
**164 · M · Subagent Documenter — генерация документации** — уровень 2
...
**165 · M · Subagent Security — поиск секретов и unsafe команд** — уровень 2
...
**166 · M · Авто-генерация новых пунктов ROADMAP** — уровень 2
...
**167 · M · Self-Improvement Queue Panel** — уровень 2
...
**168 · M · Авто-цепочки задач** — уровень 2
...
**169 · M · Граф архитектуры проекта** — уровень 2
...
**170 · M · Авто-генерация тестов для новых файлов** — уровень 2
...
**171 · M · Авто-документирование новых функций** — уровень 2
...
**172 · M · Авто-оптимизация больших файлов** — уровень 2
...
**173 · M · Авто-обновление зависимостей** — уровень 2
...
**174 · M · Авто-генерация CHANGELOG** — уровень 2
...
**175 · M · Авто-проверка лицензий** — уровень 2
...
**176 · M · Subagent Refactorer — автоматический рефакторинг** — уровень 2
...
**177 · M · Авто-генерация Roadmap Chains** — уровень 2
...
**178 · M · Subagent Performance — анализ производительности проекта** — уровень 2
...
**179 · M · Subagent Compliance — проверка соответствия стандартам** — уровень 2
...
**180 · M · Subagent Referee — сравнение двух решений** — уровень 2
...
**181 · M · find_symbol для Go** — уровень 3
...
**182 · M · find_symbol для Rust** — уровень 3
...
**183 · M · find_symbol для Java** — уровень 3
...
**184 · M · gitWorktree.ts** — уровень 3
...
**185 · M · worktreePath в чате + IPC** — уровень 3
...
**186 · M · AgentRunner — корень worktree** — уровень 3
...
**187 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**188 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**189 · M · services.ts: файловые операции** — уровень 3
...
**190 · M · services.ts: runCommand** — уровень 3
...
**193 · M · Bitbucket: create_pull_request** — уровень 3
...
**194 · M · Azure DevOps: create_work_item** — уровень 3
...
**195 · M · lspClient — spawn language server** — уровень 3
...
**196 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**197 · M · LSP pyright для Python** — уровень 3
...
**198 · M · Fetch remote skill manifest** — уровень 3
...
**199 · M · import-remote-skill UI** — уровень 3
...
**200 · M · AutomationRule в settings** — уровень 3
...
**201 · M · automationScheduler в main** — уровень 3
...
**202 · M · AutomationsTab в настройках** — уровень 3
...
**203 · M · Дублировать промпт во второй чат** — уровень 3
...
**205 · M · docker-compose для server/p2p** — уровень 3
...
**206 · M · Dashboard статуса узлов** — уровень 3
...
**207 · M · Рейтинг узлов по latency** — уровень 3
...
**211 · M · find_symbol для PHP** — уровень 3
...
**212 · M · find_symbol для Kotlin** — уровень 3
...
**213 · M · find_symbol для Swift** — уровень 3
...
**220 · M · Авто-генерация UML диаграмм** — уровень 3
...
**221 · M · Авто-генерация ER-диаграмм** — уровень 3
...
**222 · M · Авто-генерация sequence-диаграмм** — уровень 3
...
**223 · M · Авто-генерация диаграмм состояний** — уровень 3
...
**224 · M · Авто-генерация архитектурных отчётов** — уровень 3
...
**225 · M · Авто-генерация отчёта по качеству кода** — уровень 3
...
**226 · M · Авто-обнаружение дублирующихся функций** — уровень 3
...
**227 · M · Авто-обнаружение неиспользуемых зависимостей** — уровень 3
...
**228 · M · Авто-обнаружение устаревших API** — уровень 3
...
**229 · M · Авто-обнаружение потенциальных утечек памяти** — уровень 3
...
**230 · M · Авто-обнаружение неправильных async-паттернов** — уровень 3
...
**231 · M · Авто-обнаружение циклов в логике** — уровень 3
...
**232 · M · Авто-обнаружение неэффективных структур данных** — уровень 3
...
**233 · M · Авто-обнаружение неправильных путей в UI** — уровень 3
...
**234 · M · Авто-обнаружение неправильных IPC вызовов** — уровень 3
...
**235 · M · Авто-обнаружение неправильных настроек** — уровень 3
...
**236 · M · Авто-обнаружение неправильных тем UI** — уровень 3
...
**237 · M · find_symbol для Scala** — уровень 3
...
**238 · M · find_symbol для Elixir** — уровень 3
...
**239 · M · find_symbol для Haskell** — уровень 3
...
**240 · M · find_symbol для OCaml** — уровень 3
...
**241 · M · find_symbol для Lua** — уровень 3
...
**242 · M · find_symbol для Perl** — уровень 3
...
**243 · M · find_symbol для R** — уровень 3
...
**244 · M · find_symbol для MATLAB** — уровень 3
...
**245 · M · find_symbol для Julia** — уровень 3
...
**246 · M · find_symbol для Shell-скриптов** — уровень 3
...
**248 · M · LSP для Elixir** — уровень 3
...
**249 · M · LSP для Haskell** — уровень 3
...
**254 · M · LSP для MATLAB** — уровень 3
...
**256 · M · LSP для Shell-скриптов** — уровень 3
...
**257 · M · Авто-оптимизация импортов** — уровень 3
...
**258 · M · Авто-обнаружение неправильных путей в тестах** — уровень 3
...
**259 · M · Авто-обнаружение неправильных типов в UI** — уровень 3
...
**260 · M · Авто-обнаружение неправильных ключей React** — уровень 3
...
**261 · M · Авто-обнаружение неправильных зависимостей useEffect** — уровень 3
...
**262 · M · Авто-обнаружение неправильных IPC-ответов** — уровень 3
...
**263 · M · Авто-обнаружение неправильных тем в CSS** — уровень 3
...
**264 · M · Авто-обнаружение неправильных шрифтов** — уровень 3
...
**265 · M · Авто-обнаружение неправильных hotkeys в модалках** — уровень 3
...
**266 · M · Авто-обнаружение неправильных размеров файлов** — уровень 3
...
**267 · M · Авто-обнаружение неправильных токенов интеграций** — уровень 3
...
**268 · M · Авто-обнаружение неправильных worktree путей** — уровень 3
...
**269 · M · Авто-обнаружение неправильных веток Git** — уровень 3
...
**270 · M · Авто-обнаружение неправильных PR описаний** — уровень 3
...
**271 · M · Авто-обнаружение неправильных веток CI** — уровень 3
...
**272 · M · Авто-обнаружение неправильных зависимостей CI** — уровень 3
...
**273 · M · Авто-обнаружение неправильных Docker-volumes** — уровень 3
...
**274 · M · Авто-обнаружение неправильных P2P-узлов** — уровень 3
- **Цель:** проверка узлов
...
**275 · M · Авто-обнаружение неправильных P2P-маршрутов** — уровень 3
...
**276 · M · Авто-обнаружение неправильных плагинов** — уровень 3
...
**277 · M · Авто-обнаружение неправильных RAG-индексов** — уровень 3
...
**278 · M · Авто-обнаружение неправильных fallback-моделей** — уровень 3
...
**279 · M · Авто-обнаружение неправильных onboarding-шагов** — уровень 3
- **Цель:** проверка визарда
- **Файлы:** `OnboardingWizard.tsx`
- **Действие:** анализ
- **Проверка:** отчёт
...
**280 · M · Авто-обнаружение неправильных trace-панелей** — уровень 3
...
**281 · M · find_symbol для COBOL** — уровень 3
...
**282 · M · find_symbol для Fortran** — уровень 3
...
**283 · M · find_symbol для Erlang** — уровень 3
...
**284 · M · find_symbol для F#** — уровень 3
...
**285 · M · find_symbol для Prolog** — уровень 3
...
**286 · M · find_symbol для Scheme** — уровень 3
...
**287 · M · find_symbol для Lisp** — уровень 3
...
**288 · M · find_symbol для Solidity** — уровень 3
...
**289 · M · find_symbol для VHDL** — уровень 3
...
**290 · M · find_symbol для Verilog** — уровень 3
...
**292 · M · LSP для Fortran** — уровень 3
...
**293 · M · LSP для Erlang** — уровень 3
...
**295 · M · LSP для Prolog** — уровень 3
...
**296 · M · LSP для Scheme** — уровень 3
...
**298 · M · LSP для Solidity** — уровень 3
...
**300 · M · LSP для Verilog** — уровень 3
...
**301 · M · Авто-генерация диаграмм потоков управления** — уровень 3
...
**302 · M · Авто-генерация диаграмм зависимостей модулей** — уровень 3
...
**303 · M · Авто-генерация диаграмм взаимодействия компонентов** — уровень 3
...
**304 · M · Авто-генерация диаграмм API** — уровень 3
...
**305 · M · Авто-генерация диаграмм тестового покрытия** — уровень 3
...
**306 · M · Авто-генерация диаграмм Git-истории** — уровень 3
...
**307 · M · Авто-генерация диаграмм CI/CD** — уровень 3
...
**308 · M · Авто-генерация диаграмм P2P-узлов** — уровень 3
...
**309 · M · Авто-генерация диаграмм плагинов** — уровень 3
...
**310 · M · Авто-генерация диаграмм IPC-каналов** — уровень 3
...
**311 · M · Авто-генерация отчёта по архитектуре UI** — уровень 3
...
**312 · M · Авто-генерация отчёта по архитектуре backend** — уровень 3
...
**313 · M · Авто-генерация отчёта по архитектуре агента** — уровень 3
...
**314 · M · Авто-генерация отчёта по архитектуре плагинов** — уровень 3
...
**315 · M · Авто-генерация отчёта по архитектуре интеграций** — уровень 3
...
**316 · M · Авто-генерация отчёта по архитектуре CI/CD** — уровень 3
...
**317 · M · Авто-генерация отчёта по архитектуре P2P** — уровень 3
...
**318 · M · Авто-генерация отчёта по архитектуре RAG** — уровень 3
...
**319 · M · Авто-генерация отчёта по архитектуре символьного индекса** — уровень 3
...
**320 · M · Авто-генерация отчёта по архитектуре worktree** — уровень 3
...
**321 · M · Авто-обнаружение неправильных feature-flags** — уровень 3
...
**322 · M · Авто-обнаружение неправильных путей в RAG-документах** — уровень 3
...
**323 · M · Авто-обнаружение неправильных chunk-размеров RAG** — уровень 3
...
**324 · M · Авто-обнаружение неправильных индексов Milvus/Qdrant** — уровень 3
...
**325 · M · Авто-обнаружение неправильных моделей fallback** — уровень 3
- **Цель:** проверка `fallbackModels[]`
...
**326 · M · Авто-обнаружение неправильных настроек GGUF-скачиваний** — уровень 3
...
**327 · M · Авто-обнаружение неправильных настроек Editor-субагента** — уровень 3
...
**328 · M · Авто-обнаружение неправильных настроек Security-субагента** — уровень 3
...
**329 · M · Авто-обнаружение неправильных настроек Tester-субагента** — уровень 3
...
**330 · M · Авто-обнаружение неправильных настроек Documenter-субагента** — уровень 3
...
**331 · M · Авто-обнаружение неправильных настроек Compliance-субагента** — уровень 3
...
**332 · M · Авто-обнаружение неправильных правил самообучения** — уровень 3
...
**333 · M · Авто-обнаружение неправильных черновиков ввода** — уровень 3
...
**334 · M · Авто-обнаружение неправильных темной/светлой темы** — уровень 3
...
**335 · M · Авто-обнаружение неправильных preview-панелей** — уровень 3
...
**336 · M · Авто-обнаружение неправильных hot-reload плагинов** — уровень 3
...
**337 · M · Авто-обнаружение неправильных health-checks MCP** — уровень 3
...
**338 · M · Авто-обнаружение неправильных tool-schemas** — уровень 3
...
**339 · M · Авто-обнаружение неправильных tool-алиасов** — уровень 3
...
**340 · M · Авто-обнаружение неправильных tool-результатов** — уровень 3
...
**341 · M · Авто-обнаружение неправильных tool-timeouts** — уровень 3
...
**342 · M · find_symbol для Apex** — уровень 3
...
**343 · M · find_symbol для ABAP** — уровень 3
...
**344 · M · find_symbol для Dart** — уровень 3
...
**345 · M · find_symbol для Nim** — уровень 3
...
**346 · M · find_symbol для Crystal** — уровень 3
...
**347 · M · find_symbol для D** — уровень 3
...
**348 · M · find_symbol для Tcl** — уровень 3
...
**349 · M · find_symbol для PowerShell** — уровень 3
...
**350 · M · find_symbol для Batch** — уровень 3
...
**351 · M · find_symbol для Puppet** — уровень 3
...
**356 · M · LSP для Crystal** — уровень 3
...
**359 · M · LSP для PowerShell** — уровень 3
...
**361 · M · LSP для Puppet** — уровень 3
...
**362 · M · Авто-генерация диаграмм Git-ветвления** — уровень 3
...
**363 · M · Авто-генерация диаграмм Git-мерджей** — уровень 3
...
**364 · M · Авто-генерация диаграмм Git-конфликтов** — уровень 3
...
**365 · M · Авто-генерация диаграмм Git-ревью** — уровень 3
...
**366 · M · Авто-генерация диаграмм Git-релизов** — уровень 3
...
**367 · M · Авто-генерация диаграмм Git-тегов** — уровень 3
...
**368 · M · Авто-генерация диаграмм Git-коммитов** — уровень 3
...
**369 · M · Авто-генерация диаграмм Git-авторов** — уровень 3
...
**370 · M · Авто-генерация диаграмм Git-активности** — уровень 3
...
**371 · M · Авто-генерация диаграмм Git-статистики** — уровень 3
...
**372 · M · Авто-генерация отчёта по качеству тестов** — уровень 3
...
**373 · M · Авто-генерация отчёта по качеству документации** — уровень 3
...
**374 · M · Авто-генерация отчёта по качеству UI** — уровень 3
...
**375 · M · Авто-генерация отчёта по качеству UX** — уровень 3
...
**376 · M · Авто-генерация отчёта по качеству интеграций** — уровень 3
...
**377 · M · Авто-генерация отчёта по качеству плагинов** — уровень 3
...
**378 · M · Авто-генерация отчёта по качеству CI/CD** — уровень 3
...
**379 · M · Авто-генерация отчёта по качеству P2P** — уровень 3
...
**380 · M · Авто-генерация отчёта по качеству RAG** — уровень 3
...
**381 · M · Авто-генерация отчёта по качеству символьного индекса** — уровень 3
...
**382 · M · Авто-обнаружение «тяжёлых» циклов** — уровень 3
...
**383 · M · Авто-обнаружение неправильных try/catch блоков** — уровень 3
...
**384 · M · Авто-обнаружение неправильных async-итераторов** — уровень 3
...
**385 · M · Авто-обнаружение неправильных генераторов** — уровень 3
...
**386 · M · Авто-обнаружение неправильных named-экспортов** — уровень 3
...
**387 · M · Авто-обнаружение неправильных путей в CodeEditorPanel** — уровень 3
...
**388 · M · Авто-обнаружение неправильных путей в ProjectTreePanel** — уровень 3
...
**389 · M · Авто-обнаружение неправильных путей в SettingsModal** — уровень 3
...
**390 · M · Авто-обнаружение неправильных путей в MetricsPanel** — уровень 3
...
**391 · M · Авто-обнаружение неправильных путей в WelcomePanel** — уровень 3
...
**392 · M · Авто-обнаружение неправильных путей в IntegrationsTab** — уровень 3
...
**393 · M · Авто-обнаружение неправильных путей в ModelTab** — уровень 3
...
**394 · M · Авто-обнаружение неправильных путей в PerformanceTab** — уровень 3
...
**395 · M · Авто-обнаружение неправильных путей в MemoryPanel** — уровень 3
...
**396 · M · Авто-обнаружение неправильных путей в AgentStatusBar** — уровень 3
...
**397 · M · Авто-обнаружение неправильных путей в agentLogger** — уровень 3
- **Цель:** проверка логов
...
**398 · M · Авто-обнаружение неправильных путей в agent.ts** — уровень 3
...
**399 · M · Авто-обнаружение неправильных путей в agentTools** — уровень 3
- **Цель:** проверка tools
- **Файлы:** `agentTools/*`
...
**400 · M · Авто-обнаружение неправильных путей в provider-модулях** — уровень 3
...
**401 · M · Авто-обнаружение неправильных путей в fileServices** — уровень 3
...
**402 · M · Авто-обнаружение неправильных путей в preload.ts** — уровень 3
...
**403 · M · find_symbol для Q#** — уровень 3
...
**404 · M · find_symbol для Hack** — уровень 3
...
**405 · M · find_symbol для Mojo** — уровень 3
...
**406 · M · find_symbol для Zig** — уровень 3
...
**407 · M · find_symbol для Red** — уровень 3
...
**408 · M · find_symbol для ReScript** — уровень 3
...
**409 · M · find_symbol для Elm** — уровень 3
...
**410 · M · find_symbol для Futhark** — уровень 3
...
**411 · M · find_symbol для Idris** — уровень 3
...
**412 · M · find_symbol для Mercury** — уровень 3
...
**418 · M · LSP для ReScript** — уровень 3
...
**420 · M · LSP для Futhark** — уровень 3
...
**422 · M · LSP для Mercury** — уровень 3
...
**423 · M · Авто-генерация диаграмм потоков данных UI** — уровень 3
...
**424 · M · Авто-генерация диаграмм потоков данных backend** — уровень 3
...
**425 · M · Авто-генерация диаграмм потоков данных агента** — уровень 3
...
**426 · M · Авто-генерация диаграмм потоков данных плагинов** — уровень 3
...
**427 · M · Авто-генерация диаграмм потоков данных RAG** — уровень 3
...
**428 · M · Авто-генерация диаграмм потоков данных P2P** — уровень 3
...
**429 · M · Авто-генерация диаграмм потоков данных CI/CD** — уровень 3
...
**430 · M · Авто-генерация диаграмм потоков данных worktree** — уровень 3
...
**431 · M · Авто-генерация диаграмм потоков данных IPC** — уровень 3
...
**432 · M · Авто-генерация диаграмм потоков данных settings** — уровень 3
...
**433 · M · Авто-генерация отчёта по качеству архитектуры UI** — уровень 3
...
**434 · M · Авто-генерация отчёта по качеству архитектуры backend** — уровень 3
...
**435 · M · Авто-генерация отчёта по качеству архитектуры агента** — уровень 3
...
**436 · M · Авто-генерация отчёта по качеству архитектуры плагинов** — уровень 3
...
**437 · M · Авто-генерация отчёта по качеству архитектуры RAG** — уровень 3
...
**438 · M · Авто-генерация отчёта по качеству архитектуры P2P** — уровень 3
...
**439 · M · Авто-генерация отчёта по качеству архитектуры CI/CD** — уровень 3
...
**440 · M · Авто-генерация отчёта по качеству архитектуры worktree** — уровень 3
...
**441 · M · Авто-генерация отчёта по качеству архитектуры IPC** — уровень 3
...
**442 · M · Авто-генерация отчёта по качеству архитектуры settings** — уровень 3
...
**443 · M · STT — кнопка микрофона** — уровень 4
...
**444 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**445 · M · Разбивка App.tsx** — уровень 4
...
**446 · M · Разбивка agent.ts** — уровень 4
...
**447 · M · Хук useChatPanelState** — уровень 4
...
**448 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**449 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**450 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**451 · M · types.ts: доменные модули** — уровень 4
...
**452 · M · agentContext: RAG-hints** — уровень 4
...
**453 · M · agentContext: preview и prepare** — уровень 4
...
**454 · M · useAgentStream: обработчики событий** — уровень 4
...
**455 · M · preload: группы API** — уровень 4
...
**456 · M · agentTools/core: files / git / package** — уровень 4
...
**457 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**470 · M · Mermaid в ответах агента** — уровень 4
...
**475 · M · Переключатель языка в настройках** — уровень 4
...
**476 · M · i18n: строки App и шапки** — уровень 4
...
**477 · M · i18n: SettingsModal** — уровень 4
...
**478 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**479 · M · Docker dev-окружение** — уровень 4
...
**480 · M · STT улучшенный режим (VAD + шумоподавление)** — уровень 4
...
**481 · M · TTS с выбором голоса** — уровень 4
...
**482 · M · Docker-режим для агента** — уровень 4
...
**483 · M · Авто-сборка Docker-образов проекта** — уровень 4
...
**484 · M · Авто-деплой на сервер** — уровень 4
...
**485 · M · Авто-деплой на Kubernetes** — уровень 4
...
**486 · M · Авто-генерация Terraform-конфигов** — уровень 4
...
**487 · M · Авто-генерация CI/CD pipelines** — уровень 4
...
**488 · M · Авто-генерация release-notes** — уровень 4
...
**489 · M · Авто-генерация аудио-версии README** — уровень 4
...
**490 · M · Авто-генерация видео-обзора проекта** — уровень 4
...
**491 · M · Авто-генерация UI-скриншотов** — уровень 4
...
**492 · M · Авто-генерация UX-отчётов** — уровень 4
...
**493 · M · Авто-генерация цветовых тем** — уровень 4
...
**494 · M · Авто-генерация логотипов** — уровень 4
...
**495 · M · Авто-генерация маркетинговых материалов** — уровень 4
...
**496 · M · Авто-генерация документации для плагинов** — уровень 4
...
**497 · M · Авто-генерация обучающих материалов** — уровень 4
...
**498 · M · Авто-генерация руководства пользователя** — уровень 4
...
**499 · M · Авто-генерация видео-гайдов** — уровень 4
...
**500 · M · Авто-генерация видео-демонстраций UI** — уровень 4
...
**501 · M · Авто-генерация маркетинговых видео** — уровень 4
...
**502 · M · Авто-генерация тем оформления** — уровень 4
...
**503 · M · Авто-генерация UX-гайдов** — уровень 4
...
**504 · M · Авто-генерация developer-гайдов** — уровень 4
...
**505 · M · Авто-генерация документации по API плагинов** — уровень 4
...
**506 · M · Авто-генерация видео-обзоров архитектуры** — уровень 4
...
**507 · M · Авто-генерация видео-обзоров CI/CD** — уровень 4
...
**508 · M · Авто-генерация маркетинговых материалов для релизов** — уровень 4
...
**509 · M · Авто-генерация тем оформления для субагентов** — уровень 4
...
**510 · M · Авто-генерация UX-гайдов для плагинов** — уровень 4
...
**511 · M · Авто-генерация developer-гайдов для плагинов** — уровень 4
...
**512 · M · Авто-генерация документации по API RAG** — уровень 4
...
**513 · M · Авто-генерация видео-обзоров архитектуры UI** — уровень 4
...
**514 · M · Авто-генерация видео-обзоров архитектуры backend** — уровень 4
...
**515 · M · Авто-генерация маркетинговых видео для релизов** — уровень 4
...
**516 · M · Авто-генерация тем оформления для архитектурных панелей** — уровень 4
...
**517 · M · Авто-генерация UX-гайдов для архитектурных панелей** — уровень 4
...
**518 · M · Авто-генерация developer-гайдов для архитектурных панелей** — уровень 4
...
**519 · M · Авто-генерация документации по API архитектурных панелей** — уровень 4
...
**520 · L · Открепить чат в отдельное окно** — уровень 4
