...
> **Принцип чтения:** сначала **Блок 0 (пункты 1–4)** — live runtime с GitHub; только после него — «📋 В планах» (5…146). Внутри цепочки — строгий порядок.
...
**1 · L · Загрузка agent runtime из клона** — блок 0
...
**2 · M · Relaunch после обновления runtime** — блок 0
...
**3 · S · Документация live runtime** — блок 0
...
**4 · M · Тесты bundled source runtime** — блок 0
...
```text
N · [S/M/L/XL] · Краткое название — блок 0 | уровень 5…146
...
**Промпты:** блок 0 → `Выполни пункт N из ROADMAP.md — блок 0, live runtime.` · пункты 5+ → `Выполни пункт N из ROADMAP.md — самоулучшение CodeViper.`

**Правила:** блок **0 (1–4)** — первым; затем **5…146**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **5…146**. **Не начинать, пока блок 0 не в «✅ Сделано»** — иначе каждый фикс агента снова требует релиза.


### 🔴 Уровень 1 — критично (с пункта 5)

> **Цепочки:** ignore **5–6**, roadmap/github **7–11**, split-view **24–26**, onboarding **37–39**, редактор **61–62**, worktree **66–68**, LSP **90–92**, i18n **146–150**.
...
**5 · M · Валидация схемы tool при загрузке** — уровень 1
...
**6 · M · Инкрементальная индексация при изменении файлов** — уровень 1
...
**7 · M · list_pull_requests** — уровень 1
...
**9 · S · read_roadmap_item** — уровень 1
...
**10 · S · Описания search-инструментов** — уровень 1
...
**11 · M · docs/tools-api актуализация** — уровень 1
...
**12 · S · Toast при ожидании подтверждения** — уровень 2
...
**13 · M · Расширение горячих клавиш** — уровень 2
...
**14 · M · Resizable split layout** — уровень 2
...
**15 · M · FilePreviewPanel read-only** — уровень 2
...
**16 · S · ProjectTree открывает превью** — уровень 2
...
**17 · S · Копировать блок кода в MessageBody** — уровень 2
...
**18 · M · Повторить ответ ассистента** — уровень 2
...
**19 · S · Поиск по истории чатов** — уровень 2
...
**20 · S · Автосохранение черновика ввода** — уровень 2
...
**21 · S · Сохранение светлой темы в settings** — уровень 2
...
**22 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**23 · S · Ctrl+` — переключить терминал** — уровень 2
...
**24 · M · Недавние проекты** — уровень 2
...
**25 · M · planBeforeExecute в настройках** — уровень 2
...
**26 · M · Пауза после плана до подтверждения** — уровень 2
...
**27 · M · Флаг firstRunCompleted** — уровень 2
...
**28 · M · OnboardingWizard** — уровень 2
...
**29 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**30 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**31 · M · Цепочка fallback моделей** — уровень 2
...
**32 · S · Чип прогресса индексации** — уровень 2
...
**33 · S · Ручная переиндексация** — уровень 2
...
**34 · M · Аудит focus trap в модалках** — уровень 2
...
**35 · S · aria-live для статуса агента** — уровень 2
...
**36 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**37 · S · Подтверждение внешних ссылок** — уровень 2
...
**38 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**39 · M · Субагент Reviewer** — уровень 2
...
**40 · M · Субагент Tester** — уровень 2
...
**41 · M · git_blame и git_show** — уровень 2
...
**44 · M · npm_install / add_package** — уровень 2
...
**45 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**46 · M · E2E: smoke настройки и отправка** — уровень 2
...
**47 · M · Component test MessageRow** — уровень 2
...
**48 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**49 · S · docs/troubleshooting.md** — уровень 2
...
**50 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**51 · M · ModelTab: формы провайдеров** — уровень 2
...
**52 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**53 · M · Экспорт чата в Markdown** — уровень 2
...
**54 · M · IPC export-chat** — уровень 2
...
**55 · M · IPC import-chat** — уровень 2
...
**56 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**57 · M · Сохранение из редактора** — уровень 2
...
**58 · M · find_symbol для Go** — уровень 3
...
**59 · M · find_symbol для Rust** — уровень 3
...
**60 · M · find_symbol для Java** — уровень 3
...
**62 · M · worktreePath в чате + IPC** — уровень 3
...
**63 · M · AgentRunner — корень worktree** — уровень 3
...
**64 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**65 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**66 · M · services.ts: файловые операции** — уровень 3
...
**67 · M · services.ts: runCommand** — уровень 3
...
**77 · S · Skip link «К содержимому»** — уровень 3
...
**78 · S · Экспорт метрик в CSV** — уровень 3
...
**79 · S · Документация plugin-authoring** — уровень 3
...
**80 · M · Провайдер Mistral** — уровень 3
...
**81 · M · Bitbucket: create_pull_request** — уровень 3
...
**82 · M · Azure DevOps: create_work_item** — уровень 3
...
**83 · S · Discord webhook** — уровень 3
...
**84 · S · Telegram Bot уведомления** — уровень 3
...
**85 · M · lspClient — spawn language server** — уровень 3
...
**86 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**87 · M · LSP pyright для Python** — уровень 3
...
**88 · M · Fetch remote skill manifest** — уровень 3
...
**89 · M · import-remote-skill UI** — уровень 3
...
**90 · M · AutomationRule в settings** — уровень 3
...
**91 · M · automationScheduler в main** — уровень 3
...
**92 · M · AutomationsTab в настройках** — уровень 3
...
**93 · M · Дублировать промпт во второй чат** — уровень 3
...
**95 · M · docker-compose для server/p2p** — уровень 3
...
**96 · M · Dashboard статуса узлов** — уровень 3
...
**97 · M · Рейтинг узлов по latency** — уровень 3
...
**102 · S · Избранные чаты** — уровень 3
...
**103 · M · STT — кнопка микрофона** — уровень 4
...
**104 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**105 · M · Разбивка App.tsx** — уровень 4
...
**106 · M · Разбивка agent.ts** — уровень 4
...
**107 · M · Хук useChatPanelState** — уровень 4
...
**108 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**109 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**110 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**111 · M · types.ts: доменные модули** — уровень 4
...
**112 · M · agentContext: RAG-hints** — уровень 4
...
**113 · M · agentContext: preview и prepare** — уровень 4
...
**114 · M · useAgentStream: обработчики событий** — уровень 4
...
**115 · M · preload: группы API** — уровень 4
...
**116 · M · agentTools/core: files / git / package** — уровень 4
...
**117 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**118 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**130 · S · Цвет папки чатов** — уровень 4
...
**131 · M · Drag-drop папок в чат** — уровень 4
...
**132 · M · Mermaid в ответах агента** — уровень 4
...
**140 · L · Открепить чат в отдельное окно** — уровень 4
...
**141 · M · Инфраструктура i18n** — уровень 4
...
**142 · M · Переключатель языка в настройках** — уровень 4
...
**143 · M · i18n: строки App и шапки** — уровень 4
...
**144 · M · i18n: SettingsModal** — уровень 4
...
**145 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**146 · M · Docker dev-окружение** — уровень 4
...
- bundledSourceBuild: stale out/main, npm install при необходимости, npm run build в source/app через portable Node
- Startup sync packaged: runBundledSourceStartupSync при старте, фоновый pull, лимит 3 с на блокировку UI
