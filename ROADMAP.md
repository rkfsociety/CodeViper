...
**2 · M · Выбор GGUF в настройках** — приор. Low  
...
**3 · L · orchestratorModel.ts** — приор. Low  
...
**4 · M · Скачивание GGUF по умолчанию** — приор. Low  
...
**5 · S · UI секция «Оркестратор»** — приор. Low  
...
**6 · M · Интеграция в AgentRunner** — приор. Low  
...
**7 · XL · REST API сигнального сервера** — приор. Low  
...
**8 · XL · Auth на сигнальном сервере** — приор. Low  
...
**9 · M · Тумблер «Поделиться мощностью»** — приор. Low  
...
**10 · S · Диалог согласия P2P** — приор. Low  
...
**11 · M · Пауза P2P при нагрузке** — приор. Low  
...
**12 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**13 · M · TLS + шифрование промптов** — приор. Low  
...
**14 · L · Маршрутизация задач на сервере** — приор. Low  
...
**15 · L · Кредиты P2P в UI** — приор. Low  
...
**16 · M · Docker dev-окружение** — приор. Low  
...
**19 · M · CONTRIBUTING.md** — приор. Low  
...
**20 · M · typedoc + GitHub Pages** — приор. Low  
...
**21 · S · Nudge «используй RAG»** — приор. Medium  
...
**22 · L · Символьный индекс (find_symbol)** — приор. Medium  
...
**23 · M · Дерево файлов проекта** — приор. High  
...
**24 · M · Side-by-side diff** — приор. Medium  
...
**25 · S · Уведомление «агент закончил»** — приор. Medium  
...
**26 · M · Шаблоны чатов** — приор. Medium  
...
**27 · M · Авто-PR collective** — приор. Medium  
...
**28 · M · Рейтинг знаний collective** — приор. Low  
...
**29 · S · Экспорт урока в skill** — приор. Medium  
...
**30 · M · Контракт subagent** — приор. Medium  
...
**31 · L · Explorer subagent** — приор. Medium  
...
**32 · L · Editor subagent в цикле** — приор. Low  
...
**33 · S · Каналы обновлений stable/beta** — приор. Low  
...
**34 · L · Песочница для run_script** — приор. Low  
...
**35 · L · Голосовой ввод и озвучка** — приор. Low  
...
**36 · XL · LSP в редакторе** — приор. Low  
...
**37 · L · Skill marketplace** — приор. Low  
...
**38 · M · E2E на Linux/macOS в CI** — приор. Medium  
