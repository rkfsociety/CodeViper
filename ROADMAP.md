...
**Правила:** пункты **1…138**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **1…138**. Цепочки 🔗 — строгий порядок внутри группы: roadmap/github **1–3**, split/preview **8–10**, plan **19–20**, onboarding **21–23**, редактор **50–51**, worktree **55–57**, LSP **79–81**, i18n **135–138**.

### 🔗 ROADMAP и GitHub для агента

**1 · S · read_roadmap_item** — уровень 1
...
**2 · S · Описания search-инструментов** — уровень 1
...
**3 · M · docs/tools-api актуализация** — уровень 1
...
**4 · S · Toast при ожидании подтверждения** — уровень 2
...
**5 · M · Расширение горячих клавиш** — уровень 2
...
**6 · M · Resizable split layout** — уровень 2
...
**7 · M · FilePreviewPanel read-only** — уровень 2
...
**8 · S · ProjectTree открывает превью** — уровень 2
...
**9 · S · Копировать блок кода в MessageBody** — уровень 2
...
**10 · M · Повторить ответ ассистента** — уровень 2
...
**11 · S · Поиск по истории чатов** — уровень 2
...
**12 · S · Автосохранение черновика ввода** — уровень 2
...
**13 · S · Сохранение светлой темы в settings** — уровень 2
...
**14 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**15 · S · Ctrl+` — переключить терминал** — уровень 2
...
**16 · M · Недавние проекты** — уровень 2
...
**17 · M · planBeforeExecute в настройках** — уровень 2
...
**18 · M · Пауза после плана до подтверждения** — уровень 2
...
**19 · M · Флаг firstRunCompleted** — уровень 2
...
**20 · M · OnboardingWizard** — уровень 2
...
**21 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**22 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**23 · M · Цепочка fallback моделей** — уровень 2
...
**24 · S · Чип прогресса индексации** — уровень 2
...
**25 · S · Ручная переиндексация** — уровень 2
...
**26 · M · Аудит focus trap в модалках** — уровень 2
...
**27 · S · aria-live для статуса агента** — уровень 2
...
**28 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**29 · S · Подтверждение внешних ссылок** — уровень 2
...
**30 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**31 · M · Субагент Reviewer** — уровень 2
...
**32 · M · Субагент Tester** — уровень 2
...
**33 · M · git_blame и git_show** — уровень 2
...
**36 · M · npm_install / add_package** — уровень 2
...
**37 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**38 · M · E2E: smoke настройки и отправка** — уровень 2
...
**39 · M · Component test MessageRow** — уровень 2
...
**40 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**41 · S · docs/troubleshooting.md** — уровень 2
...
**42 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**43 · M · ModelTab: формы провайдеров** — уровень 2
...
**44 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**45 · M · Экспорт чата в Markdown** — уровень 2
...
**46 · M · IPC export-chat** — уровень 2
...
**47 · M · IPC import-chat** — уровень 2
...
**48 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**49 · M · Сохранение из редактора** — уровень 2
...
**50 · M · find_symbol для Go** — уровень 3
...
**51 · M · find_symbol для Rust** — уровень 3
...
**52 · M · find_symbol для Java** — уровень 3
...
**54 · M · worktreePath в чате + IPC** — уровень 3
...
**55 · M · AgentRunner — корень worktree** — уровень 3
...
**56 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**57 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**58 · M · services.ts: файловые операции** — уровень 3
...
**59 · M · services.ts: runCommand** — уровень 3
...
**69 · S · Skip link «К содержимому»** — уровень 3
...
**70 · S · Экспорт метрик в CSV** — уровень 3
...
**71 · S · Документация plugin-authoring** — уровень 3
...
**72 · M · Провайдер Mistral** — уровень 3
...
**73 · M · Bitbucket: create_pull_request** — уровень 3
...
**74 · M · Azure DevOps: create_work_item** — уровень 3
...
**75 · S · Discord webhook** — уровень 3
...
**76 · S · Telegram Bot уведомления** — уровень 3
...
**77 · M · lspClient — spawn language server** — уровень 3
...
**78 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**79 · M · LSP pyright для Python** — уровень 3
...
**80 · M · Fetch remote skill manifest** — уровень 3
...
**81 · M · import-remote-skill UI** — уровень 3
...
**82 · M · AutomationRule в settings** — уровень 3
...
**83 · M · automationScheduler в main** — уровень 3
...
**84 · M · AutomationsTab в настройках** — уровень 3
...
**85 · M · Дублировать промпт во второй чат** — уровень 3
...
**87 · M · docker-compose для server/p2p** — уровень 3
...
**88 · M · Dashboard статуса узлов** — уровень 3
...
**89 · M · Рейтинг узлов по latency** — уровень 3
...
**95 · M · STT — кнопка микрофона** — уровень 4
...
**96 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**97 · M · Разбивка App.tsx** — уровень 4
...
**98 · M · Разбивка agent.ts** — уровень 4
...
**99 · M · Хук useChatPanelState** — уровень 4
...
**100 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**101 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**102 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**103 · M · types.ts: доменные модули** — уровень 4
...
**104 · M · agentContext: RAG-hints** — уровень 4
...
**105 · M · agentContext: preview и prepare** — уровень 4
...
**106 · M · useAgentStream: обработчики событий** — уровень 4
...
**107 · M · preload: группы API** — уровень 4
...
**108 · M · agentTools/core: files / git / package** — уровень 4
...
**109 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**110 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**122 · S · Цвет папки чатов** — уровень 4
...
**123 · M · Drag-drop папок в чат** — уровень 4
...
**124 · M · Mermaid в ответах агента** — уровень 4
...
**132 · L · Открепить чат в отдельное окно** — уровень 4
...
**133 · M · Инфраструктура i18n** — уровень 4
...
**134 · M · Переключатель языка в настройках** — уровень 4
...
**135 · M · i18n: строки App и шапки** — уровень 4
...
**136 · M · i18n: SettingsModal** — уровень 4
...
**137 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**138 · M · Docker dev-окружение** — уровень 4
