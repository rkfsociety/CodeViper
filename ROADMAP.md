...
**1 · M · Интеграция в AgentRunner** — приор. Low  
...
**2 · XL · REST API сигнального сервера** — приор. Low  
...
**3 · XL · Auth на сигнальном сервере** — приор. Low  
...
**4 · M · Тумблер «Поделиться мощностью»** — приор. Low  
...
**5 · S · Диалог согласия P2P** — приор. Low  
...
**6 · M · Пауза P2P при нагрузке** — приор. Low  
...
**7 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**8 · M · TLS + шифрование промптов** — приор. Low  
...
**9 · L · Маршрутизация задач на сервере** — приор. Low  
...
**10 · L · Кредиты P2P в UI** — приор. Low  
...
**11 · M · Docker dev-окружение** — приор. Low  
...
**14 · M · CONTRIBUTING.md** — приор. Low  
...
**15 · M · typedoc + GitHub Pages** — приор. Low  
...
**17 · L · Символьный индекс (find_symbol)** — приор. Medium  
...
**29 · L · Песочница для run_script** — приор. Low  
