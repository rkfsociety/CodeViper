...
**Правила:** пункты **1…130**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **1…130**. Цепочки 🔗 — строгий порядок внутри группы: split/preview (готово), plan **10–11**, onboarding **12–14**, редактор **41–42**, worktree **46–48**, LSP **70–72**, i18n **126–130**.
...
**1 · S · Копировать блок кода в MessageBody** — уровень 2
...
**2 · M · Повторить ответ ассистента** — уровень 2
...
**3 · S · Поиск по истории чатов** — уровень 2
...
**4 · S · Автосохранение черновика ввода** — уровень 2
...
**5 · S · Сохранение светлой темы в settings** — уровень 2
...
**6 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**7 · S · Ctrl+` — переключить терминал** — уровень 2
...
**8 · M · Недавние проекты** — уровень 2
...
**9 · M · planBeforeExecute в настройках** — уровень 2
...
**10 · M · Пауза после плана до подтверждения** — уровень 2
...
**11 · M · Флаг firstRunCompleted** — уровень 2
...
**12 · M · OnboardingWizard** — уровень 2
...
**13 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**14 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**15 · M · Цепочка fallback моделей** — уровень 2
...
**16 · S · Чип прогресса индексации** — уровень 2
...
**17 · S · Ручная переиндексация** — уровень 2
...
**18 · M · Аудит focus trap в модалках** — уровень 2
...
**19 · S · aria-live для статуса агента** — уровень 2
...
**20 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**21 · S · Подтверждение внешних ссылок** — уровень 2
...
**22 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**23 · M · Субагент Reviewer** — уровень 2
...
**24 · M · Субагент Tester** — уровень 2
...
**25 · M · git_blame и git_show** — уровень 2
...
**28 · M · npm_install / add_package** — уровень 2
...
**29 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**30 · M · E2E: smoke настройки и отправка** — уровень 2
...
**31 · M · Component test MessageRow** — уровень 2
...
**32 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**33 · S · docs/troubleshooting.md** — уровень 2
...
**34 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**35 · M · ModelTab: формы провайдеров** — уровень 2
...
**36 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**37 · M · Экспорт чата в Markdown** — уровень 2
...
**38 · M · IPC export-chat** — уровень 2
...
**39 · M · IPC import-chat** — уровень 2
...
**40 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**41 · M · Сохранение из редактора** — уровень 2
...
**42 · M · find_symbol для Go** — уровень 3
...
**43 · M · find_symbol для Rust** — уровень 3
...
**44 · M · find_symbol для Java** — уровень 3
...
**46 · M · worktreePath в чате + IPC** — уровень 3
...
**47 · M · AgentRunner — корень worktree** — уровень 3
...
**48 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**49 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**50 · M · services.ts: файловые операции** — уровень 3
...
**51 · M · services.ts: runCommand** — уровень 3
...
**61 · S · Skip link «К содержимому»** — уровень 3
...
**62 · S · Экспорт метрик в CSV** — уровень 3
...
**63 · S · Документация plugin-authoring** — уровень 3
...
**64 · M · Провайдер Mistral** — уровень 3
...
**65 · M · Bitbucket: create_pull_request** — уровень 3
...
**66 · M · Azure DevOps: create_work_item** — уровень 3
...
**67 · S · Discord webhook** — уровень 3
...
**68 · S · Telegram Bot уведомления** — уровень 3
...
**69 · M · lspClient — spawn language server** — уровень 3
...
**70 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**71 · M · LSP pyright для Python** — уровень 3
...
**72 · M · Fetch remote skill manifest** — уровень 3
...
**73 · M · import-remote-skill UI** — уровень 3
...
**74 · M · AutomationRule в settings** — уровень 3
...
**75 · M · automationScheduler в main** — уровень 3
...
**76 · M · AutomationsTab в настройках** — уровень 3
...
**77 · M · Дублировать промпт во второй чат** — уровень 3
...
**79 · M · docker-compose для server/p2p** — уровень 3
...
**80 · M · Dashboard статуса узлов** — уровень 3
...
**81 · M · Рейтинг узлов по latency** — уровень 3
...
**87 · M · STT — кнопка микрофона** — уровень 4
...
**88 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**89 · M · Разбивка App.tsx** — уровень 4
...
**90 · M · Разбивка agent.ts** — уровень 4
...
**91 · M · Хук useChatPanelState** — уровень 4
...
**92 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**93 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**94 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**95 · M · types.ts: доменные модули** — уровень 4
...
**96 · M · agentContext: RAG-hints** — уровень 4
...
**97 · M · agentContext: preview и prepare** — уровень 4
...
**98 · M · useAgentStream: обработчики событий** — уровень 4
...
**99 · M · preload: группы API** — уровень 4
...
**100 · M · agentTools/core: files / git / package** — уровень 4
...
**101 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**102 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**114 · S · Цвет папки чатов** — уровень 4
...
**115 · M · Drag-drop папок в чат** — уровень 4
...
**116 · M · Mermaid в ответах агента** — уровень 4
...
**124 · L · Открепить чат в отдельное окно** — уровень 4
...
**125 · M · Инфраструктура i18n** — уровень 4
...
**126 · M · Переключатель языка в настройках** — уровень 4
...
**127 · M · i18n: строки App и шапки** — уровень 4
...
**128 · M · i18n: SettingsModal** — уровень 4
...
**129 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**130 · M · Docker dev-окружение** — уровень 4
