...
> **Принцип чтения:** **Блок 0 выполнен** — live runtime с GitHub. Дальше «📋 В планах» (3…144); внутри цепочки — строгий порядок.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 3…144
...
**Правила:** пункты **3…144**; внутри цепочки — строго по порядку.
...
**3 · M · Валидация схемы tool при загрузке** — уровень 1
...
**4 · M · Инкрементальная индексация при изменении файлов** — уровень 1
...
**5 · M · list_pull_requests** — уровень 1
...
**7 · S · read_roadmap_item** — уровень 1
...
**8 · S · Описания search-инструментов** — уровень 1
...
**9 · M · docs/tools-api актуализация** — уровень 1
...
**10 · S · Toast при ожидании подтверждения** — уровень 2
...
**11 · M · Расширение горячих клавиш** — уровень 2
...
**12 · M · Resizable split layout** — уровень 2
...
**13 · M · FilePreviewPanel read-only** — уровень 2
...
**14 · S · ProjectTree открывает превью** — уровень 2
...
**15 · S · Копировать блок кода в MessageBody** — уровень 2
...
**16 · M · Повторить ответ ассистента** — уровень 2
...
**17 · S · Поиск по истории чатов** — уровень 2
...
**18 · S · Автосохранение черновика ввода** — уровень 2
...
**19 · S · Сохранение светлой темы в settings** — уровень 2
...
**20 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**21 · S · Ctrl+` — переключить терминал** — уровень 2
...
**22 · M · Недавние проекты** — уровень 2
...
**23 · M · planBeforeExecute в настройках** — уровень 2
...
**24 · M · Пауза после плана до подтверждения** — уровень 2
...
**25 · M · Флаг firstRunCompleted** — уровень 2
...
**26 · M · OnboardingWizard** — уровень 2
...
**27 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**28 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**29 · M · Цепочка fallback моделей** — уровень 2
...
**30 · S · Чип прогресса индексации** — уровень 2
...
**31 · S · Ручная переиндексация** — уровень 2
...
**32 · M · Аудит focus trap в модалках** — уровень 2
...
**33 · S · aria-live для статуса агента** — уровень 2
...
**34 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**35 · S · Подтверждение внешних ссылок** — уровень 2
...
**36 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**37 · M · Субагент Reviewer** — уровень 2
...
**38 · M · Субагент Tester** — уровень 2
...
**39 · M · git_blame и git_show** — уровень 2
...
**42 · M · npm_install / add_package** — уровень 2
...
**43 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**44 · M · E2E: smoke настройки и отправка** — уровень 2
...
**45 · M · Component test MessageRow** — уровень 2
...
**46 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**47 · S · docs/troubleshooting.md** — уровень 2
...
**48 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**49 · M · ModelTab: формы провайдеров** — уровень 2
...
**50 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**51 · M · Экспорт чата в Markdown** — уровень 2
...
**52 · M · IPC export-chat** — уровень 2
...
**53 · M · IPC import-chat** — уровень 2
...
**54 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**55 · M · Сохранение из редактора** — уровень 2
...
**56 · M · find_symbol для Go** — уровень 3
...
**57 · M · find_symbol для Rust** — уровень 3
...
**58 · M · find_symbol для Java** — уровень 3
...
**60 · M · worktreePath в чате + IPC** — уровень 3
...
**61 · M · AgentRunner — корень worktree** — уровень 3
...
**62 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**63 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**64 · M · services.ts: файловые операции** — уровень 3
...
**65 · M · services.ts: runCommand** — уровень 3
...
**75 · S · Skip link «К содержимому»** — уровень 3
...
**76 · S · Экспорт метрик в CSV** — уровень 3
...
**77 · S · Документация plugin-authoring** — уровень 3
...
**78 · M · Провайдер Mistral** — уровень 3
...
**79 · M · Bitbucket: create_pull_request** — уровень 3
...
**80 · M · Azure DevOps: create_work_item** — уровень 3
...
**81 · S · Discord webhook** — уровень 3
...
**82 · S · Telegram Bot уведомления** — уровень 3
...
**83 · M · lspClient — spawn language server** — уровень 3
...
**84 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**85 · M · LSP pyright для Python** — уровень 3
...
**86 · M · Fetch remote skill manifest** — уровень 3
...
**87 · M · import-remote-skill UI** — уровень 3
...
**88 · M · AutomationRule в settings** — уровень 3
...
**89 · M · automationScheduler в main** — уровень 3
...
**90 · M · AutomationsTab в настройках** — уровень 3
...
**91 · M · Дублировать промпт во второй чат** — уровень 3
...
**93 · M · docker-compose для server/p2p** — уровень 3
...
**94 · M · Dashboard статуса узлов** — уровень 3
...
**95 · M · Рейтинг узлов по latency** — уровень 3
...
**100 · S · Избранные чаты** — уровень 3
...
**101 · M · STT — кнопка микрофона** — уровень 4
...
**102 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**103 · M · Разбивка App.tsx** — уровень 4
...
**104 · M · Разбивка agent.ts** — уровень 4
...
**105 · M · Хук useChatPanelState** — уровень 4
...
**106 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**107 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**108 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**109 · M · types.ts: доменные модули** — уровень 4
...
**110 · M · agentContext: RAG-hints** — уровень 4
...
**111 · M · agentContext: preview и prepare** — уровень 4
...
**112 · M · useAgentStream: обработчики событий** — уровень 4
...
**113 · M · preload: группы API** — уровень 4
...
**114 · M · agentTools/core: files / git / package** — уровень 4
...
**115 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**116 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**128 · S · Цвет папки чатов** — уровень 4
...
**129 · M · Drag-drop папок в чат** — уровень 4
...
**130 · M · Mermaid в ответах агента** — уровень 4
...
**138 · L · Открепить чат в отдельное окно** — уровень 4
...
**139 · M · Инфраструктура i18n** — уровень 4
...
**140 · M · Переключатель языка в настройках** — уровень 4
...
**141 · M · i18n: строки App и шапки** — уровень 4
...
**142 · M · i18n: SettingsModal** — уровень 4
...
**143 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**144 · M · Docker dev-окружение** — уровень 4
