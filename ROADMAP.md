...
**Правила:** нумерация сквозная (1…17); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
> Пункты 6–7 — код сервера в репозитории (`server/p2p/`); деплой VPS — вручную пользователем.
...
**2 · S · Уведомление «агент закончил»** — приор. Medium  
...
**3 · M · Шаблоны чатов** — приор. Medium  
...
**4 · M · Авто-PR collective** — приор. Medium  
...
**5 · M · Рейтинг знаний collective** — приор. Low  
...
**6 · S · Экспорт урока в skill** — приор. Medium  
...
**7 · M · Контракт subagent** — приор. Medium  
...
**8 · L · Explorer subagent** — приор. Medium  
...
**9 · L · Editor subagent в цикле** — приор. Low  
...
**10 · S · Каналы обновлений stable/beta** — приор. Low  
...
**11 · L · Песочница для run_script** — приор. Medium  
...
**15 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**16 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**17 · M · Счётчик стоимости облачных запросов** — приор. Medium  
