...
> **Принцип чтения:** сначала **Блок 0 (пункты 1–5)** — live runtime с GitHub; только после него — «📋 В планах» (6…147). Внутри цепочки — строгий порядок.
...
**1 · M · Сборка runtime в клоне** — блок 0
...
**2 · L · Загрузка agent runtime из клона** — блок 0
...
**3 · M · Relaunch после обновления runtime** — блок 0
...
**4 · S · Документация live runtime** — блок 0
...
**5 · M · Тесты bundled source runtime** — блок 0
...
```text
N · [S/M/L/XL] · Краткое название — блок 0 | уровень 6…147
...
**Промпты:** блок 0 → `Выполни пункт N из ROADMAP.md — блок 0, live runtime.` · пункты 6+ → `Выполни пункт N из ROADMAP.md — самоулучшение CodeViper.`

**Правила:** блок **0 (1–5)** — первым; затем **6…147**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **6…147**. **Не начинать, пока блок 0 не в «✅ Сделано»** — иначе каждый фикс агента снова требует релиза.


### 🔴 Уровень 1 — критично (с пункта 6)

> **Цепочки:** ignore **6–7**, roadmap/github **8–12**, split-view **25–27**, onboarding **38–40**, редактор **62–63**, worktree **67–69**, LSP **91–93**, i18n **147–151**.
...
**8 · M · list_pull_requests** — уровень 1
...
**10 · S · read_roadmap_item** — уровень 1
...
**11 · S · Описания search-инструментов** — уровень 1
...
**12 · M · docs/tools-api актуализация** — уровень 1
...
**13 · S · Toast при ожидании подтверждения** — уровень 2
...
**14 · M · Расширение горячих клавиш** — уровень 2
...
**15 · M · Resizable split layout** — уровень 2
...
**16 · M · FilePreviewPanel read-only** — уровень 2
...
**17 · S · ProjectTree открывает превью** — уровень 2
...
**18 · S · Копировать блок кода в MessageBody** — уровень 2
...
**19 · M · Повторить ответ ассистента** — уровень 2
...
**20 · S · Поиск по истории чатов** — уровень 2
...
**21 · S · Автосохранение черновика ввода** — уровень 2
...
**22 · S · Сохранение светлой темы в settings** — уровень 2
...
**23 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**24 · S · Ctrl+` — переключить терминал** — уровень 2
...
**25 · M · Недавние проекты** — уровень 2
...
**26 · M · planBeforeExecute в настройках** — уровень 2
...
**27 · M · Пауза после плана до подтверждения** — уровень 2
...
**28 · M · Флаг firstRunCompleted** — уровень 2
...
**29 · M · OnboardingWizard** — уровень 2
...
**30 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**31 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**32 · M · Цепочка fallback моделей** — уровень 2
...
**33 · S · Чип прогресса индексации** — уровень 2
...
**34 · S · Ручная переиндексация** — уровень 2
...
**35 · M · Аудит focus trap в модалках** — уровень 2
...
**36 · S · aria-live для статуса агента** — уровень 2
...
**37 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**38 · S · Подтверждение внешних ссылок** — уровень 2
...
**39 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**40 · M · Субагент Reviewer** — уровень 2
...
**41 · M · Субагент Tester** — уровень 2
...
**42 · M · git_blame и git_show** — уровень 2
...
**45 · M · npm_install / add_package** — уровень 2
...
**46 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**47 · M · E2E: smoke настройки и отправка** — уровень 2
...
**48 · M · Component test MessageRow** — уровень 2
...
**49 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**50 · S · docs/troubleshooting.md** — уровень 2
...
**51 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**52 · M · ModelTab: формы провайдеров** — уровень 2
...
**53 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**54 · M · Экспорт чата в Markdown** — уровень 2
...
**55 · M · IPC export-chat** — уровень 2
...
**56 · M · IPC import-chat** — уровень 2
...
**57 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**58 · M · Сохранение из редактора** — уровень 2
...
**59 · M · find_symbol для Go** — уровень 3
...
**60 · M · find_symbol для Rust** — уровень 3
...
**61 · M · find_symbol для Java** — уровень 3
...
**63 · M · worktreePath в чате + IPC** — уровень 3
...
**64 · M · AgentRunner — корень worktree** — уровень 3
...
**65 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**66 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**67 · M · services.ts: файловые операции** — уровень 3
...
**68 · M · services.ts: runCommand** — уровень 3
...
**78 · S · Skip link «К содержимому»** — уровень 3
...
**79 · S · Экспорт метрик в CSV** — уровень 3
...
**80 · S · Документация plugin-authoring** — уровень 3
...
**81 · M · Провайдер Mistral** — уровень 3
...
**82 · M · Bitbucket: create_pull_request** — уровень 3
...
**83 · M · Azure DevOps: create_work_item** — уровень 3
...
**84 · S · Discord webhook** — уровень 3
...
**85 · S · Telegram Bot уведомления** — уровень 3
...
**86 · M · lspClient — spawn language server** — уровень 3
...
**87 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**88 · M · LSP pyright для Python** — уровень 3
...
**89 · M · Fetch remote skill manifest** — уровень 3
...
**90 · M · import-remote-skill UI** — уровень 3
...
**91 · M · AutomationRule в settings** — уровень 3
...
**92 · M · automationScheduler в main** — уровень 3
...
**93 · M · AutomationsTab в настройках** — уровень 3
...
**94 · M · Дублировать промпт во второй чат** — уровень 3
...
**96 · M · docker-compose для server/p2p** — уровень 3
...
**97 · M · Dashboard статуса узлов** — уровень 3
...
**98 · M · Рейтинг узлов по latency** — уровень 3
...
**103 · S · Избранные чаты** — уровень 3
...
**104 · M · STT — кнопка микрофона** — уровень 4
...
**105 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**106 · M · Разбивка App.tsx** — уровень 4
...
**107 · M · Разбивка agent.ts** — уровень 4
...
**108 · M · Хук useChatPanelState** — уровень 4
...
**109 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**110 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**111 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**112 · M · types.ts: доменные модули** — уровень 4
...
**113 · M · agentContext: RAG-hints** — уровень 4
...
**114 · M · agentContext: preview и prepare** — уровень 4
...
**115 · M · useAgentStream: обработчики событий** — уровень 4
...
**116 · M · preload: группы API** — уровень 4
...
**117 · M · agentTools/core: files / git / package** — уровень 4
...
**118 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**119 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**131 · S · Цвет папки чатов** — уровень 4
...
**132 · M · Drag-drop папок в чат** — уровень 4
...
**133 · M · Mermaid в ответах агента** — уровень 4
...
**141 · L · Открепить чат в отдельное окно** — уровень 4
...
**142 · M · Инфраструктура i18n** — уровень 4
...
**143 · M · Переключатель языка в настройках** — уровень 4
...
**144 · M · i18n: строки App и шапки** — уровень 4
...
**145 · M · i18n: SettingsModal** — уровень 4
...
**146 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**147 · M · Docker dev-окружение** — уровень 4
