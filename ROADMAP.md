...
> **Принцип чтения:** сначала **Блок 0 (пункты 1–3)** — live runtime с GitHub; только после него — «📋 В планах» (4…145). Внутри цепочки — строгий порядок.
...
**1 · M · Relaunch после обновления runtime** — блок 0
...
**2 · S · Документация live runtime** — блок 0
...
**3 · M · Тесты bundled source runtime** — блок 0
...
```text
N · [S/M/L/XL] · Краткое название — блок 0 | уровень 4…145
...
**Промпты:** блок 0 → `Выполни пункт N из ROADMAP.md — блок 0, live runtime.` · пункты 4+ → `Выполни пункт N из ROADMAP.md — самоулучшение CodeViper.`

**Правила:** блок **0 (1–3)** — первым; затем **4…145**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **4…145**. **Не начинать, пока блок 0 не в «✅ Сделано»** — иначе каждый фикс агента снова требует релиза.


### 🔴 Уровень 1 — критично (с пункта 4)

> **Цепочки:** ignore **4–5**, roadmap/github **6–10**, split-view **23–25**, onboarding **36–38**, редактор **60–61**, worktree **65–67**, LSP **89–91**, i18n **145–149**.
...
**5 · M · Инкрементальная индексация при изменении файлов** — уровень 1
...
**6 · M · list_pull_requests** — уровень 1
...
**8 · S · read_roadmap_item** — уровень 1
...
**9 · S · Описания search-инструментов** — уровень 1
...
**10 · M · docs/tools-api актуализация** — уровень 1
...
**11 · S · Toast при ожидании подтверждения** — уровень 2
...
**12 · M · Расширение горячих клавиш** — уровень 2
...
**13 · M · Resizable split layout** — уровень 2
...
**14 · M · FilePreviewPanel read-only** — уровень 2
...
**15 · S · ProjectTree открывает превью** — уровень 2
...
**16 · S · Копировать блок кода в MessageBody** — уровень 2
...
**17 · M · Повторить ответ ассистента** — уровень 2
...
**18 · S · Поиск по истории чатов** — уровень 2
...
**19 · S · Автосохранение черновика ввода** — уровень 2
...
**20 · S · Сохранение светлой темы в settings** — уровень 2
...
**21 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**22 · S · Ctrl+` — переключить терминал** — уровень 2
...
**23 · M · Недавние проекты** — уровень 2
...
**24 · M · planBeforeExecute в настройках** — уровень 2
...
**25 · M · Пауза после плана до подтверждения** — уровень 2
...
**26 · M · Флаг firstRunCompleted** — уровень 2
...
**27 · M · OnboardingWizard** — уровень 2
...
**28 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**29 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**30 · M · Цепочка fallback моделей** — уровень 2
...
**31 · S · Чип прогресса индексации** — уровень 2
...
**32 · S · Ручная переиндексация** — уровень 2
...
**33 · M · Аудит focus trap в модалках** — уровень 2
...
**34 · S · aria-live для статуса агента** — уровень 2
...
**35 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**36 · S · Подтверждение внешних ссылок** — уровень 2
...
**37 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**38 · M · Субагент Reviewer** — уровень 2
...
**39 · M · Субагент Tester** — уровень 2
...
**40 · M · git_blame и git_show** — уровень 2
...
**43 · M · npm_install / add_package** — уровень 2
...
**44 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**45 · M · E2E: smoke настройки и отправка** — уровень 2
...
**46 · M · Component test MessageRow** — уровень 2
...
**47 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**48 · S · docs/troubleshooting.md** — уровень 2
...
**49 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**50 · M · ModelTab: формы провайдеров** — уровень 2
...
**51 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**52 · M · Экспорт чата в Markdown** — уровень 2
...
**53 · M · IPC export-chat** — уровень 2
...
**54 · M · IPC import-chat** — уровень 2
...
**55 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**56 · M · Сохранение из редактора** — уровень 2
...
**57 · M · find_symbol для Go** — уровень 3
...
**58 · M · find_symbol для Rust** — уровень 3
...
**59 · M · find_symbol для Java** — уровень 3
...
**61 · M · worktreePath в чате + IPC** — уровень 3
...
**62 · M · AgentRunner — корень worktree** — уровень 3
...
**63 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**64 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**65 · M · services.ts: файловые операции** — уровень 3
...
**66 · M · services.ts: runCommand** — уровень 3
...
**76 · S · Skip link «К содержимому»** — уровень 3
...
**77 · S · Экспорт метрик в CSV** — уровень 3
...
**78 · S · Документация plugin-authoring** — уровень 3
...
**79 · M · Провайдер Mistral** — уровень 3
...
**80 · M · Bitbucket: create_pull_request** — уровень 3
...
**81 · M · Azure DevOps: create_work_item** — уровень 3
...
**82 · S · Discord webhook** — уровень 3
...
**83 · S · Telegram Bot уведомления** — уровень 3
...
**84 · M · lspClient — spawn language server** — уровень 3
...
**85 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**86 · M · LSP pyright для Python** — уровень 3
...
**87 · M · Fetch remote skill manifest** — уровень 3
...
**88 · M · import-remote-skill UI** — уровень 3
...
**89 · M · AutomationRule в settings** — уровень 3
...
**90 · M · automationScheduler в main** — уровень 3
...
**91 · M · AutomationsTab в настройках** — уровень 3
...
**92 · M · Дублировать промпт во второй чат** — уровень 3
...
**94 · M · docker-compose для server/p2p** — уровень 3
...
**95 · M · Dashboard статуса узлов** — уровень 3
...
**96 · M · Рейтинг узлов по latency** — уровень 3
...
**101 · S · Избранные чаты** — уровень 3
...
**102 · M · STT — кнопка микрофона** — уровень 4
...
**103 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**104 · M · Разбивка App.tsx** — уровень 4
...
**105 · M · Разбивка agent.ts** — уровень 4
...
**106 · M · Хук useChatPanelState** — уровень 4
...
**107 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**108 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**109 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**110 · M · types.ts: доменные модули** — уровень 4
...
**111 · M · agentContext: RAG-hints** — уровень 4
...
**112 · M · agentContext: preview и prepare** — уровень 4
...
**113 · M · useAgentStream: обработчики событий** — уровень 4
...
**114 · M · preload: группы API** — уровень 4
...
**115 · M · agentTools/core: files / git / package** — уровень 4
...
**116 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**117 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**129 · S · Цвет папки чатов** — уровень 4
...
**130 · M · Drag-drop папок в чат** — уровень 4
...
**131 · M · Mermaid в ответах агента** — уровень 4
...
**139 · L · Открепить чат в отдельное окно** — уровень 4
...
**140 · M · Инфраструктура i18n** — уровень 4
...
**141 · M · Переключатель языка в настройках** — уровень 4
...
**142 · M · i18n: строки App и шапки** — уровень 4
...
**143 · M · i18n: SettingsModal** — уровень 4
...
**144 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**145 · M · Docker dev-окружение** — уровень 4
