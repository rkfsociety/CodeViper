...
**13 · L · Символьный индекс (find_symbol)** — приор. High  
...
**25 · L · Песочница для run_script** — приор. Medium  
...
**30 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**31 · M · Счётчик стоимости облачных запросов** — приор. Medium  
