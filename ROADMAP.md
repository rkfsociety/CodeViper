...
- Веб-инструменты агента: `web_search` (SearXNG локально через Docker, fallback DuckDuckGo) и `web_fetch` (загрузка URL, HTML→текст); SearXNG стартует вместе с приложением, останавливается при закрытии
