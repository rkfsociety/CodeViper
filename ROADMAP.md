...
> **Цепочки:** ignore **3–4**, roadmap/github **5–9**, split-view **22–24**, onboarding **35–37**, редактор **59–60**, worktree **64–66**, LSP **88–90**, i18n **144–148**.
...
> Ежедневный UX, превью файлов, onboarding, провайдеры, субагенты, E2E, ModelTab. Пункты **17–57** — выполнять сверху вниз; цепочки см. блок уровня 1.
...
> Символы, worktree, рефакторинг IPC/services, интеграции, LSP, автоматизации, P2P. Пункты **58–102**.
...
> Голос, рефакторинг монолитов, i18n, Docker, polish. Пункты **111–153** — когда уровни 1–3 закрыты.
