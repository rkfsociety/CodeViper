...
**Правила:** нумерация сквозная (1…27); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
**1 · L · Маршрутизация задач на сервере** — приор. Low  
...
**2 · L · Кредиты P2P в UI** — приор. Low  
...
**7 · M · typedoc + GitHub Pages** — приор. Low  
...
**8 · S · Nudge «используй RAG»** — приор. Medium  
...
**9 · L · Символьный индекс (find_symbol)** — приор. High  
...
**10 · M · Дерево файлов проекта** — приор. High  
...
**11 · M · Side-by-side diff** — приор. Medium  
...
**12 · S · Уведомление «агент закончил»** — приор. Medium  
...
**13 · M · Шаблоны чатов** — приор. Medium  
...
**14 · M · Авто-PR collective** — приор. Medium  
...
**15 · M · Рейтинг знаний collective** — приор. Low  
...
**16 · S · Экспорт урока в skill** — приор. Medium  
...
**17 · M · Контракт subagent** — приор. Medium  
...
**18 · L · Explorer subagent** — приор. Medium  
...
**19 · L · Editor subagent в цикле** — приор. Low  
...
**20 · S · Каналы обновлений stable/beta** — приор. Low  
...
**21 · L · Песочница для run_script** — приор. Medium  
...
**22 · L · Голосовой ввод и озвучка** — приор. Low  
...
**23 · XL · LSP в редакторе** — приор. Low  
...
**24 · L · Skill marketplace** — приор. Low  
...
**25 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**26 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**27 · M · Счётчик стоимости облачных запросов** — приор. Medium  
