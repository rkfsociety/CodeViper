...
> **Принцип чтения:** пункты **1…145 отсортированы по важности** (🔴→🟢). Новые инструменты агента — цепочки **7–8**, **19–23**, **52–56**. Внутри цепочки — строгий порядок; между несвязанными пунктами — тоже сверху вниз. Пропускать к более низкому уровню без причины не рекомендуется.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 1…145
...
**Правила:** нумерация **1…145 по убыванию важности** (уровень 1 — первым); внутри цепочки — строго по порядку; один пункт = один прогон; после проверки — `complete_self_improvement_item`.

## 📋 В планах

> Нумерация сквозная **1…145** — **отсортировано по важности и пользе** (уровни 1→4). Сначала надёжность и ядро, затем UX, расширения, polish. Сложность: S / M / L / XL. Выполненные цепочки см. «✅ Сделано».
...
**2 · M · Удалить deprecated cloudApiKey** — уровень 1
...
**3 · M · Инкрементальная индексация при изменении файлов** — уровень 1
...
**4 · M · Health-check MCP при старте** — уровень 1
...
**5 · M · Вкл/выкл MCP-tools по серверу** — уровень 1
