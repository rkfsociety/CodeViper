...
> **Принцип чтения:** пункты **1…154 отсортированы по важности** (🔴→🟢). Новые инструменты агента — цепочки **7–8**, **19–23**, **52–56**. Внутри цепочки — строгий порядок; между несвязанными пунктами — тоже сверху вниз. Пропускать к более низкому уровню без причины не рекомендуется.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 1…154
...
**Правила:** нумерация **1…154 по убыванию важности** (уровень 1 — первым); внутри цепочки — строго по порядку; один пункт = один прогон; после проверки — `complete_self_improvement_item`.

## 📋 В планах

> Нумерация сквозная **1…154** — **отсортировано по важности и пользе** (уровни 1→4). Сначала надёжность и ядро, затем UX, расширения, polish. Сложность: S / M / L / XL. Выполненные цепочки см. «✅ Сделано».
...
**1 · M · Coverage пороги electron/main** — уровень 1
...
**5 · S · ignore в grep_files / find_files** — уровень 1
...
**6 · S · MUTATING_TOOLS: GitHub и файловые ops** — уровень 1
...
**7 · M · Валидация схемы tool при загрузке** — уровень 1
...
**8 · S · Лимит стоимости за прогон** — уровень 1
...
**9 · M · Удалить deprecated cloudApiKey** — уровень 1
...
**10 · M · Unit-тест Ollama fallback** — уровень 1
...
**11 · M · git_stash / git_stash_pop** — уровень 1
...
**12 · M · Инкрементальная индексация при изменении файлов** — уровень 1
...
**13 · M · Health-check MCP при старте** — уровень 1
...
**14 · M · Вкл/выкл MCP-tools по серверу** — уровень 1
...
**15 · M · list_pull_requests** — уровень 1
...
**17 · S · read_roadmap_item** — уровень 1
...
**18 · S · Описания search-инструментов** — уровень 1
...
**19 · M · docs/tools-api актуализация** — уровень 1
...
**20 · S · Toast при ожидании подтверждения** — уровень 2
...
**21 · M · Расширение горячих клавиш** — уровень 2
...
**22 · M · Resizable split layout** — уровень 2
...
**23 · M · FilePreviewPanel read-only** — уровень 2
...
**24 · S · ProjectTree открывает превью** — уровень 2
...
**25 · S · Копировать блок кода в MessageBody** — уровень 2
...
**26 · M · Повторить ответ ассистента** — уровень 2
...
**27 · S · Поиск по истории чатов** — уровень 2
...
**28 · S · Автосохранение черновика ввода** — уровень 2
...
**29 · S · Сохранение светлой темы в settings** — уровень 2
...
**30 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**31 · S · Ctrl+` — переключить терминал** — уровень 2
...
**32 · M · Недавние проекты** — уровень 2
...
**33 · M · planBeforeExecute в настройках** — уровень 2
...
**34 · M · Пауза после плана до подтверждения** — уровень 2
...
**35 · M · Флаг firstRunCompleted** — уровень 2
...
**36 · M · OnboardingWizard** — уровень 2
...
**37 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**38 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**39 · M · Цепочка fallback моделей** — уровень 2
...
**40 · S · Чип прогресса индексации** — уровень 2
...
**41 · S · Ручная переиндексация** — уровень 2
...
**42 · M · Аудит focus trap в модалках** — уровень 2
...
**43 · S · aria-live для статуса агента** — уровень 2
...
**44 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**45 · S · Подтверждение внешних ссылок** — уровень 2
...
**46 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**47 · M · Субагент Reviewer** — уровень 2
...
**48 · M · Субагент Tester** — уровень 2
...
**49 · M · git_blame и git_show** — уровень 2
...
**52 · M · npm_install / add_package** — уровень 2
...
**53 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**54 · M · E2E: smoke настройки и отправка** — уровень 2
...
**55 · M · Component test MessageRow** — уровень 2
...
**56 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**57 · S · docs/troubleshooting.md** — уровень 2
...
**58 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**59 · M · ModelTab: формы провайдеров** — уровень 2
...
**60 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**61 · M · Экспорт чата в Markdown** — уровень 2
...
**62 · M · IPC export-chat** — уровень 2
...
**63 · M · IPC import-chat** — уровень 2
...
**64 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**65 · M · Сохранение из редактора** — уровень 2
...
**66 · M · find_symbol для Go** — уровень 3
...
**67 · M · find_symbol для Rust** — уровень 3
...
**68 · M · find_symbol для Java** — уровень 3
...
**70 · M · worktreePath в чате + IPC** — уровень 3
...
**71 · M · AgentRunner — корень worktree** — уровень 3
...
**72 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**73 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**74 · M · services.ts: файловые операции** — уровень 3
...
**75 · M · services.ts: runCommand** — уровень 3
...
**85 · S · Skip link «К содержимому»** — уровень 3
...
**86 · S · Экспорт метрик в CSV** — уровень 3
...
**87 · S · Документация plugin-authoring** — уровень 3
...
**88 · M · Провайдер Mistral** — уровень 3
...
**89 · M · Bitbucket: create_pull_request** — уровень 3
...
**90 · M · Azure DevOps: create_work_item** — уровень 3
...
**91 · S · Discord webhook** — уровень 3
...
**92 · S · Telegram Bot уведомления** — уровень 3
...
**93 · M · lspClient — spawn language server** — уровень 3
...
**94 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**95 · M · LSP pyright для Python** — уровень 3
...
**96 · M · Fetch remote skill manifest** — уровень 3
...
**97 · M · import-remote-skill UI** — уровень 3
...
**98 · M · AutomationRule в settings** — уровень 3
...
**99 · M · automationScheduler в main** — уровень 3
...
**100 · M · AutomationsTab в настройках** — уровень 3
...
**101 · M · Дублировать промпт во второй чат** — уровень 3
...
**103 · M · docker-compose для server/p2p** — уровень 3
...
**104 · M · Dashboard статуса узлов** — уровень 3
...
**105 · M · Рейтинг узлов по latency** — уровень 3
...
**110 · S · Избранные чаты** — уровень 3
...
**111 · M · STT — кнопка микрофона** — уровень 4
...
**112 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**113 · M · Разбивка App.tsx** — уровень 4
...
**114 · M · Разбивка agent.ts** — уровень 4
...
**115 · M · Хук useChatPanelState** — уровень 4
...
**116 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**117 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**118 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**119 · M · types.ts: доменные модули** — уровень 4
...
**120 · M · agentContext: RAG-hints** — уровень 4
...
**121 · M · agentContext: preview и prepare** — уровень 4
...
**122 · M · useAgentStream: обработчики событий** — уровень 4
...
**123 · M · preload: группы API** — уровень 4
...
**124 · M · agentTools/core: files / git / package** — уровень 4
...
**125 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**126 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**138 · S · Цвет папки чатов** — уровень 4
...
**139 · M · Drag-drop папок в чат** — уровень 4
...
**140 · M · Mermaid в ответах агента** — уровень 4
...
**148 · L · Открепить чат в отдельное окно** — уровень 4
...
**149 · M · Инфраструктура i18n** — уровень 4
...
**150 · M · Переключатель языка в настройках** — уровень 4
...
**151 · M · i18n: строки App и шапки** — уровень 4
...
**152 · M · i18n: SettingsModal** — уровень 4
...
**153 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**154 · M · Docker dev-окружение** — уровень 4
