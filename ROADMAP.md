...
**Правила:** нумерация сквозная (1…26); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
**1 · L · Кредиты P2P в UI** — приор. Low  
...
**6 · M · typedoc + GitHub Pages** — приор. Low  
...
**7 · S · Nudge «используй RAG»** — приор. Medium  
...
**8 · L · Символьный индекс (find_symbol)** — приор. High  
...
**9 · M · Дерево файлов проекта** — приор. High  
...
**10 · M · Side-by-side diff** — приор. Medium  
...
**11 · S · Уведомление «агент закончил»** — приор. Medium  
...
**12 · M · Шаблоны чатов** — приор. Medium  
...
**13 · M · Авто-PR collective** — приор. Medium  
...
**14 · M · Рейтинг знаний collective** — приор. Low  
...
**15 · S · Экспорт урока в skill** — приор. Medium  
...
**16 · M · Контракт subagent** — приор. Medium  
...
**17 · L · Explorer subagent** — приор. Medium  
...
**18 · L · Editor subagent в цикле** — приор. Low  
...
**19 · S · Каналы обновлений stable/beta** — приор. Low  
...
**20 · L · Песочница для run_script** — приор. Medium  
...
**21 · L · Голосовой ввод и озвучка** — приор. Low  
...
**22 · XL · LSP в редакторе** — приор. Low  
...
**23 · L · Skill marketplace** — приор. Low  
...
**24 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**25 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**26 · M · Счётчик стоимости облачных запросов** — приор. Medium  
