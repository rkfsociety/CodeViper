...
> Пункты **1…134**. Цепочки 🔗 — строгий порядок внутри группы: split/preview **2–4**, plan **13–14**, onboarding **15–17**, редактор **44–45**, worktree **49–51**, LSP **73–75**, i18n **129–133**.
...
**1 · M · Расширение горячих клавиш** — уровень 2
...
**2 · M · Resizable split layout** — уровень 2
...
**3 · M · FilePreviewPanel read-only** — уровень 2
...
**4 · S · ProjectTree открывает превью** — уровень 2
...
**5 · S · Копировать блок кода в MessageBody** — уровень 2
...
**6 · M · Повторить ответ ассистента** — уровень 2
...
**7 · S · Поиск по истории чатов** — уровень 2
...
**8 · S · Автосохранение черновика ввода** — уровень 2
...
**9 · S · Сохранение светлой темы в settings** — уровень 2
...
**10 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**11 · S · Ctrl+` — переключить терминал** — уровень 2
...
**12 · M · Недавние проекты** — уровень 2
...
**13 · M · planBeforeExecute в настройках** — уровень 2
...
**14 · M · Пауза после плана до подтверждения** — уровень 2
...
**15 · M · Флаг firstRunCompleted** — уровень 2
...
**16 · M · OnboardingWizard** — уровень 2
...
**17 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**18 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**19 · M · Цепочка fallback моделей** — уровень 2
...
**20 · S · Чип прогресса индексации** — уровень 2
...
**21 · S · Ручная переиндексация** — уровень 2
...
**22 · M · Аудит focus trap в модалках** — уровень 2
...
**23 · S · aria-live для статуса агента** — уровень 2
...
**24 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**25 · S · Подтверждение внешних ссылок** — уровень 2
...
**26 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**27 · M · Субагент Reviewer** — уровень 2
...
**28 · M · Субагент Tester** — уровень 2
...
**29 · M · git_blame и git_show** — уровень 2
...
**32 · M · npm_install / add_package** — уровень 2
...
**33 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**34 · M · E2E: smoke настройки и отправка** — уровень 2
...
**35 · M · Component test MessageRow** — уровень 2
...
**36 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**37 · S · docs/troubleshooting.md** — уровень 2
...
**38 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**39 · M · ModelTab: формы провайдеров** — уровень 2
...
**40 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**41 · M · Экспорт чата в Markdown** — уровень 2
...
**42 · M · IPC export-chat** — уровень 2
...
**43 · M · IPC import-chat** — уровень 2
...
**44 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**45 · M · Сохранение из редактора** — уровень 2
