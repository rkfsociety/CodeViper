...
**Правила:** нумерация сквозная (1…31); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
**1 · M · Пауза P2P при нагрузке** — приор. Low  
...
**2 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**3 · M · TLS + шифрование промптов** — приор. Low  
...
**4 · L · Маршрутизация задач на сервере** — приор. Low  
...
**5 · L · Кредиты P2P в UI** — приор. Low  
...
**6 · M · Docker dev-окружение** — приор. Low  
...
**10 · M · typedoc + GitHub Pages** — приор. Low  
...
**11 · S · Nudge «используй RAG»** — приор. Medium  
...
**12 · L · Символьный индекс (find_symbol)** — приор. High  
...
**13 · M · Дерево файлов проекта** — приор. High  
...
**14 · M · Side-by-side diff** — приор. Medium  
...
**15 · S · Уведомление «агент закончил»** — приор. Medium  
...
**16 · M · Шаблоны чатов** — приор. Medium  
...
**17 · M · Авто-PR collective** — приор. Medium  
...
**18 · M · Рейтинг знаний collective** — приор. Low  
...
**19 · S · Экспорт урока в skill** — приор. Medium  
...
**20 · M · Контракт subagent** — приор. Medium  
...
**21 · L · Explorer subagent** — приор. Medium  
...
**22 · L · Editor subagent в цикле** — приор. Low  
...
**23 · S · Каналы обновлений stable/beta** — приор. Low  
...
**24 · L · Песочница для run_script** — приор. Medium  
...
**25 · L · Голосовой ввод и озвучка** — приор. Low  
...
**26 · XL · LSP в редакторе** — приор. Low  
...
**27 · L · Skill marketplace** — приор. Low  
...
**28 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**29 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**30 · M · Счётчик стоимости облачных запросов** — приор. Medium  
