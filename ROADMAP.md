...
> **Принцип чтения:** пункты **1…148 отсортированы по важности** (🔴→🟢). Новые инструменты агента — цепочки **7–8**, **19–23**, **52–56**. Внутри цепочки — строгий порядок; между несвязанными пунктами — тоже сверху вниз. Пропускать к более низкому уровню без причины не рекомендуется.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 1…148
...
**2 · S · Лимит стоимости за прогон** — уровень 1
...
**3 · M · Удалить deprecated cloudApiKey** — уровень 1
...
**4 · M · Unit-тест Ollama fallback** — уровень 1
...
**5 · M · git_stash / git_stash_pop** — уровень 1
...
**7 · M · Health-check MCP при старте** — уровень 1
...
**8 · M · Вкл/выкл MCP-tools по серверу** — уровень 1
