...
**1 · L · orchestratorModel.ts** — приор. Low  
...
**2 · M · Скачивание GGUF по умолчанию** — приор. Low  
...
**3 · S · UI секция «Оркестратор»** — приор. Low  
...
**4 · M · Интеграция в AgentRunner** — приор. Low  
...
**5 · XL · REST API сигнального сервера** — приор. Low  
...
**6 · XL · Auth на сигнальном сервере** — приор. Low  
...
**7 · M · Тумблер «Поделиться мощностью»** — приор. Low  
...
**8 · S · Диалог согласия P2P** — приор. Low  
...
**9 · M · Пауза P2P при нагрузке** — приор. Low  
...
**10 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**11 · M · TLS + шифрование промптов** — приор. Low  
...
**12 · L · Маршрутизация задач на сервере** — приор. Low  
...
**13 · L · Кредиты P2P в UI** — приор. Low  
...
**14 · M · Docker dev-окружение** — приор. Low  
...
**17 · M · CONTRIBUTING.md** — приор. Low  
...
**18 · M · typedoc + GitHub Pages** — приор. Low  
...
**19 · S · Nudge «используй RAG»** — приор. Medium  
...
**20 · L · Символьный индекс (find_symbol)** — приор. Medium  
...
**21 · M · Дерево файлов проекта** — приор. High  
...
**22 · M · Side-by-side diff** — приор. Medium  
...
**23 · S · Уведомление «агент закончил»** — приор. Medium  
...
**24 · M · Шаблоны чатов** — приор. Medium  
...
**25 · M · Авто-PR collective** — приор. Medium  
...
**26 · M · Рейтинг знаний collective** — приор. Low  
...
**27 · S · Экспорт урока в skill** — приор. Medium  
...
**28 · M · Контракт subagent** — приор. Medium  
...
**29 · L · Explorer subagent** — приор. Medium  
...
**30 · L · Editor subagent в цикле** — приор. Low  
...
**31 · S · Каналы обновлений stable/beta** — приор. Low  
...
**32 · L · Песочница для run_script** — приор. Low  
...
**33 · L · Голосовой ввод и озвучка** — приор. Low  
...
**34 · XL · LSP в редакторе** — приор. Low  
...
**35 · L · Skill marketplace** — приор. Low  
...
**36 · M · E2E на Linux/macOS в CI** — приор. Medium  
