...
**Правила:** нумерация сквозная (1…32); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
**12 · M · @-упоминание файлов в поле ввода** — приор. High  
...
**14 · L · Символьный индекс (find_symbol)** — приор. High  
...
**26 · L · Песочница для run_script** — приор. Medium  
...
**31 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**32 · M · Счётчик стоимости облачных запросов** — приор. Medium  
