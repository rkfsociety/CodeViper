...
**Правила:** нумерация сквозная (1…18); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
> Пункты 7–8 — код сервера в репозитории (`server/p2p/`); деплой VPS — вручную пользователем.
...
**2 · M · Side-by-side diff** — приор. Medium  
...
**3 · S · Уведомление «агент закончил»** — приор. Medium  
...
**4 · M · Шаблоны чатов** — приор. Medium  
...
**5 · M · Авто-PR collective** — приор. Medium  
...
**6 · M · Рейтинг знаний collective** — приор. Low  
...
**7 · S · Экспорт урока в skill** — приор. Medium  
...
**8 · M · Контракт subagent** — приор. Medium  
...
**9 · L · Explorer subagent** — приор. Medium  
...
**10 · L · Editor subagent в цикле** — приор. Low  
...
**11 · S · Каналы обновлений stable/beta** — приор. Low  
...
**12 · L · Песочница для run_script** — приор. Medium  
...
**16 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**17 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**18 · M · Счётчик стоимости облачных запросов** — приор. Medium  
