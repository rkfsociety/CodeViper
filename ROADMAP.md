...
**Правила:** нумерация сквозная (1…19); внутри цепочки — строго по порядку; один пункт = один прогон самоулучшения; после проверки — `complete_self_improvement_item`.
...
> Пункты 8–9 — код сервера в репозитории (`server/p2p/`); деплой VPS — вручную пользователем.
...
**2 · M · Дерево файлов проекта** — приор. High  
...
**3 · M · Side-by-side diff** — приор. Medium  
...
**4 · S · Уведомление «агент закончил»** — приор. Medium  
...
**5 · M · Шаблоны чатов** — приор. Medium  
...
**6 · M · Авто-PR collective** — приор. Medium  
...
**7 · M · Рейтинг знаний collective** — приор. Low  
...
**8 · S · Экспорт урока в skill** — приор. Medium  
...
**9 · M · Контракт subagent** — приор. Medium  
...
**10 · L · Explorer subagent** — приор. Medium  
...
**11 · L · Editor subagent в цикле** — приор. Low  
...
**12 · S · Каналы обновлений stable/beta** — приор. Low  
...
**13 · L · Песочница для run_script** — приор. Medium  
...
**17 · M · E2E на Linux/macOS в CI** — приор. Medium  
...
**18 · L · Авто-цикл «тесты → почини»** — приор. Medium  
...
**19 · M · Счётчик стоимости облачных запросов** — приор. Medium  
