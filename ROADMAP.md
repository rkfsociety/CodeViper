...
> **Принцип чтения:** пункты **1…149 отсортированы по важности** (🔴→🟢). Новые инструменты агента — цепочки **7–8**, **19–23**, **52–56**. Внутри цепочки — строгий порядок; между несвязанными пунктами — тоже сверху вниз. Пропускать к более низкому уровню без причины не рекомендуется.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 1…149
...
**Правила:** нумерация **1…149 по убыванию важности** (уровень 1 — первым); внутри цепочки — строго по порядку; один пункт = один прогон; после проверки — `complete_self_improvement_item`.

## 📋 В планах

> Нумерация сквозная **1…149** — **отсортировано по важности и пользе** (уровни 1→4). Сначала надёжность и ядро, затем UX, расширения, polish. Сложность: S / M / L / XL. Выполненные цепочки см. «✅ Сделано».
...
**1 · S · MUTATING_TOOLS: GitHub и файловые ops** — уровень 1
...
**2 · M · Валидация схемы tool при загрузке** — уровень 1
...
**3 · S · Лимит стоимости за прогон** — уровень 1
...
**4 · M · Удалить deprecated cloudApiKey** — уровень 1
...
**5 · M · Unit-тест Ollama fallback** — уровень 1
...
**6 · M · git_stash / git_stash_pop** — уровень 1
...
**7 · M · Инкрементальная индексация при изменении файлов** — уровень 1
...
**8 · M · Health-check MCP при старте** — уровень 1
...
**9 · M · Вкл/выкл MCP-tools по серверу** — уровень 1
...
**10 · M · list_pull_requests** — уровень 1
...
**12 · S · read_roadmap_item** — уровень 1
...
**13 · S · Описания search-инструментов** — уровень 1
...
**14 · M · docs/tools-api актуализация** — уровень 1
...
**15 · S · Toast при ожидании подтверждения** — уровень 2
...
**16 · M · Расширение горячих клавиш** — уровень 2
...
**17 · M · Resizable split layout** — уровень 2
...
**18 · M · FilePreviewPanel read-only** — уровень 2
...
**19 · S · ProjectTree открывает превью** — уровень 2
...
**20 · S · Копировать блок кода в MessageBody** — уровень 2
...
**21 · M · Повторить ответ ассистента** — уровень 2
...
**22 · S · Поиск по истории чатов** — уровень 2
...
**23 · S · Автосохранение черновика ввода** — уровень 2
...
**24 · S · Сохранение светлой темы в settings** — уровень 2
...
**25 · M · Quick Open — палитра файлов Ctrl+P** — уровень 2
...
**26 · S · Ctrl+` — переключить терминал** — уровень 2
...
**27 · M · Недавние проекты** — уровень 2
...
**28 · M · planBeforeExecute в настройках** — уровень 2
...
**29 · M · Пауза после плана до подтверждения** — уровень 2
...
**30 · M · Флаг firstRunCompleted** — уровень 2
...
**31 · M · OnboardingWizard** — уровень 2
...
**32 · S · Ссылка на example-prompts в визарде** — уровень 2
...
**33 · M · OpenAI-compatible произвольный endpoint** — уровень 2
...
**34 · M · Цепочка fallback моделей** — уровень 2
...
**35 · S · Чип прогресса индексации** — уровень 2
...
**36 · S · Ручная переиндексация** — уровень 2
...
**37 · M · Аудит focus trap в модалках** — уровень 2
...
**38 · S · aria-live для статуса агента** — уровень 2
...
**39 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**40 · S · Подтверждение внешних ссылок** — уровень 2
...
**41 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**42 · M · Субагент Reviewer** — уровень 2
...
**43 · M · Субагент Tester** — уровень 2
...
**44 · M · git_blame и git_show** — уровень 2
...
**47 · M · npm_install / add_package** — уровень 2
...
**48 · S · create_pr vs create_codeviper_pr** — уровень 2
...
**49 · M · E2E: smoke настройки и отправка** — уровень 2
...
**50 · M · Component test MessageRow** — уровень 2
...
**51 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`  
- **Проверка:** `npm run test:e2e`


**52 · S · docs/troubleshooting.md** — уровень 2
...
**53 · S · README: Linux и macOS в быстром старте** — уровень 2
...
**54 · M · ModelTab: формы провайдеров** — уровень 2
...
**55 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**56 · M · Экспорт чата в Markdown** — уровень 2
...
**57 · M · IPC export-chat** — уровень 2
...
**58 · M · IPC import-chat** — уровень 2
...
**59 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**60 · M · Сохранение из редактора** — уровень 2
...
**61 · M · find_symbol для Go** — уровень 3
...
**62 · M · find_symbol для Rust** — уровень 3
...
**63 · M · find_symbol для Java** — уровень 3
...
**65 · M · worktreePath в чате + IPC** — уровень 3
...
**66 · M · AgentRunner — корень worktree** — уровень 3
...
**67 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**68 · M · ipcContracts: IPC enum и Contracts** — уровень 3
...
**69 · M · services.ts: файловые операции** — уровень 3
...
**70 · M · services.ts: runCommand** — уровень 3
...
**80 · S · Skip link «К содержимому»** — уровень 3
...
**81 · S · Экспорт метрик в CSV** — уровень 3
...
**82 · S · Документация plugin-authoring** — уровень 3
...
**83 · M · Провайдер Mistral** — уровень 3
...
**84 · M · Bitbucket: create_pull_request** — уровень 3
...
**85 · M · Azure DevOps: create_work_item** — уровень 3
...
**86 · S · Discord webhook** — уровень 3
...
**87 · S · Telegram Bot уведомления** — уровень 3
...
**88 · M · lspClient — spawn language server** — уровень 3
...
**89 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**90 · M · LSP pyright для Python** — уровень 3
...
**91 · M · Fetch remote skill manifest** — уровень 3
...
**92 · M · import-remote-skill UI** — уровень 3
...
**93 · M · AutomationRule в settings** — уровень 3
...
**94 · M · automationScheduler в main** — уровень 3
...
**95 · M · AutomationsTab в настройках** — уровень 3
...
**96 · M · Дублировать промпт во второй чат** — уровень 3
...
**98 · M · docker-compose для server/p2p** — уровень 3
...
**99 · M · Dashboard статуса узлов** — уровень 3
...
**100 · M · Рейтинг узлов по latency** — уровень 3
...
**105 · S · Избранные чаты** — уровень 3
...
**106 · M · STT — кнопка микрофона** — уровень 4
...
**107 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**108 · M · Разбивка App.tsx** — уровень 4
...
**109 · M · Разбивка agent.ts** — уровень 4
...
**110 · M · Хук useChatPanelState** — уровень 4
...
**111 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**112 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**113 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**114 · M · types.ts: доменные модули** — уровень 4
...
**115 · M · agentContext: RAG-hints** — уровень 4
...
**116 · M · agentContext: preview и prepare** — уровень 4
...
**117 · M · useAgentStream: обработчики событий** — уровень 4
...
**118 · M · preload: группы API** — уровень 4
...
**119 · M · agentTools/core: files / git / package** — уровень 4
...
**120 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**121 · M · BehaviorTab: инструменты и промпты** — уровень 4
...
**133 · S · Цвет папки чатов** — уровень 4
...
**134 · M · Drag-drop папок в чат** — уровень 4
...
**135 · M · Mermaid в ответах агента** — уровень 4
...
**143 · L · Открепить чат в отдельное окно** — уровень 4
...
**144 · M · Инфраструктура i18n** — уровень 4
...
**145 · M · Переключатель языка в настройках** — уровень 4
...
**146 · M · i18n: строки App и шапки** — уровень 4
...
**147 · M · i18n: SettingsModal** — уровень 4
...
**148 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**149 · M · Docker dev-окружение** — уровень 4
