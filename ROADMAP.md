...
> **Принцип чтения:** **Блок 0 выполнен** — live runtime с GitHub. Дальше «📋 В планах» (3…143); внутри цепочки 🔗 — строгий порядок.
...
```text
N · [S/M/L/XL] · Краткое название — уровень 3…143
...
**Правила:** пункты **3…143**; внутри цепочки — строго по порядку.

## 📋 В планах

> Пункты **3…143** (141 задача). Цепочки 🔗 — строгий порядок внутри группы: индексация **3**, roadmap/github **4–8**, split/preview **11–13**, plan **22–23**, onboarding **24–26**, редактор **53–54**, worktree **58–60**, LSP **82–84**, i18n **138–142**.
...
**4 · M · list_pull_requests** — уровень 1
...
> Ежедневный UX, превью файлов, onboarding, провайдеры, субагенты, E2E, ModelTab. Пункты **9–54** — выполнять сверху вниз; цепочки см. шапку раздела.
