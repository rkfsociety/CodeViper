...
**1 · M · Выбор GGUF в настройках** — приор. Low  
...
**2 · L · orchestratorModel.ts** — приор. Low  
...
**3 · M · Скачивание GGUF по умолчанию** — приор. Low  
...
**4 · S · UI секция «Оркестратор»** — приор. Low  
...
**5 · M · Интеграция в AgentRunner** — приор. Low  
...
**6 · XL · REST API сигнального сервера** — приор. Low  
...
**7 · XL · Auth на сигнальном сервере** — приор. Low  
...
**8 · M · Тумблер «Поделиться мощностью»** — приор. Low  
...
**9 · S · Диалог согласия P2P** — приор. Low  
...
**10 · M · Пауза P2P при нагрузке** — приор. Low  
...
**11 · M · Лимит 3 входящих P2P-задач** — приор. Low  
...
**12 · M · TLS + шифрование промптов** — приор. Low  
...
**13 · L · Маршрутизация задач на сервере** — приор. Low  
...
**14 · L · Кредиты P2P в UI** — приор. Low  
...
**15 · M · Docker dev-окружение** — приор. Low  
...
**18 · M · CONTRIBUTING.md** — приор. Low  
...
**19 · M · typedoc + GitHub Pages** — приор. Low  
...
**20 · S · Nudge «используй RAG»** — приор. Medium  
...
**21 · L · Символьный индекс (find_symbol)** — приор. Medium  
...
**22 · M · Дерево файлов проекта** — приор. High  
...
**23 · M · Side-by-side diff** — приор. Medium  
...
**24 · S · Уведомление «агент закончил»** — приор. Medium  
...
**25 · M · Шаблоны чатов** — приор. Medium  
...
**26 · M · Авто-PR collective** — приор. Medium  
...
**27 · M · Рейтинг знаний collective** — приор. Low  
...
**28 · S · Экспорт урока в skill** — приор. Medium  
...
**29 · M · Контракт subagent** — приор. Medium  
...
**30 · L · Explorer subagent** — приор. Medium  
...
**31 · L · Editor subagent в цикле** — приор. Low  
...
**32 · S · Каналы обновлений stable/beta** — приор. Low  
...
**33 · L · Песочница для run_script** — приор. Low  
...
**34 · L · Голосовой ввод и озвучка** — приор. Low  
...
**35 · XL · LSP в редакторе** — приор. Low  
...
**36 · L · Skill marketplace** — приор. Low  
...
**37 · M · E2E на Linux/macOS в CI** — приор. Medium  
