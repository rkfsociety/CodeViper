...
Пункты 270–314: onboarding, RAG, чанки, эмбеддинги и отчёты качества.

Всего пунктов: 45.

**269 · M · Авто-обнаружение неправильных onboarding-шагов** — уровень 3
...
**270 · M · Авто-обнаружение неправильных trace-панелей** — уровень 3
...
**271 · M · find_symbol для COBOL** — уровень 3
...
**272 · M · find_symbol для Fortran** — уровень 3
...
**273 · M · find_symbol для Erlang** — уровень 3
...
**274 · M · find_symbol для F#** — уровень 3
...
**275 · M · find_symbol для Prolog** — уровень 3
...
**276 · M · find_symbol для Scheme** — уровень 3
...
**277 · M · find_symbol для Lisp** — уровень 3
...
**278 · M · find_symbol для Solidity** — уровень 3
...
**279 · M · find_symbol для VHDL** — уровень 3
...
**280 · M · find_symbol для Verilog** — уровень 3
...
**282 · M · LSP для Fortran** — уровень 3
...
**283 · M · LSP для Erlang** — уровень 3
...
**285 · M · LSP для Prolog** — уровень 3
...
**286 · M · LSP для Scheme** — уровень 3
...
**288 · M · LSP для Solidity** — уровень 3
...
**290 · M · LSP для Verilog** — уровень 3
...
**291 · M · Авто-генерация диаграмм потоков управления** — уровень 3
...
**292 · M · Авто-генерация диаграмм зависимостей модулей** — уровень 3
...
**293 · M · Авто-генерация диаграмм взаимодействия компонентов** — уровень 3
...
**294 · M · Авто-генерация диаграмм API** — уровень 3
...
**295 · M · Авто-генерация диаграмм тестового покрытия** — уровень 3
...
**296 · M · Авто-генерация диаграмм Git-истории** — уровень 3
...
**297 · M · Авто-генерация диаграмм CI/CD** — уровень 3
...
**298 · M · Авто-генерация диаграмм P2P-узлов** — уровень 3
...
**299 · M · Авто-генерация диаграмм плагинов** — уровень 3
...
**300 · M · Авто-генерация диаграмм IPC-каналов** — уровень 3
...
**301 · M · Авто-генерация отчёта по архитектуре UI** — уровень 3
...
**302 · M · Авто-генерация отчёта по архитектуре backend** — уровень 3
...
**303 · M · Авто-генерация отчёта по архитектуре агента** — уровень 3
...
**304 · M · Авто-генерация отчёта по архитектуре плагинов** — уровень 3
...
**305 · M · Авто-генерация отчёта по архитектуре интеграций** — уровень 3
...
**306 · M · Авто-генерация отчёта по архитектуре CI/CD** — уровень 3
...
**307 · M · Авто-генерация отчёта по архитектуре P2P** — уровень 3
...
**308 · M · Авто-генерация отчёта по архитектуре RAG** — уровень 3
...
**309 · M · Авто-генерация отчёта по архитектуре символьного индекса** — уровень 3
...
**310 · M · Авто-генерация отчёта по архитектуре worktree** — уровень 3
...
**311 · M · Авто-обнаружение неправильных feature-flags** — уровень 3
...
**312 · M · Авто-обнаружение неправильных путей в RAG-документах** — уровень 3
...
**313 · M · Авто-обнаружение неправильных chunk-размеров RAG** — уровень 3
