...
Пункты 225–269: onboarding, RAG, чанки, эмбеддинги и отчёты качества.

Всего пунктов: 45.

**225 · M · Авто-обнаружение неправильных onboarding-шагов** — уровень 3
...
**226 · M · Авто-обнаружение неправильных trace-панелей** — уровень 3
...
**227 · M · find_symbol для COBOL** — уровень 3
...
**228 · M · find_symbol для Fortran** — уровень 3
...
**229 · M · find_symbol для Erlang** — уровень 3
...
**230 · M · find_symbol для F#** — уровень 3
...
**231 · M · find_symbol для Prolog** — уровень 3
...
**232 · M · find_symbol для Scheme** — уровень 3
...
**233 · M · find_symbol для Lisp** — уровень 3
...
**234 · M · find_symbol для Solidity** — уровень 3
...
**235 · M · find_symbol для VHDL** — уровень 3
...
**236 · M · find_symbol для Verilog** — уровень 3
...
**238 · M · LSP для Fortran** — уровень 3
...
**239 · M · LSP для Erlang** — уровень 3
...
**241 · M · LSP для Prolog** — уровень 3
...
**242 · M · LSP для Scheme** — уровень 3
...
**244 · M · LSP для Solidity** — уровень 3
...
**246 · M · LSP для Verilog** — уровень 3
...
**247 · M · Авто-генерация диаграмм потоков управления** — уровень 3
...
**248 · M · Авто-генерация диаграмм зависимостей модулей** — уровень 3
...
**249 · M · Авто-генерация диаграмм взаимодействия компонентов** — уровень 3
...
**250 · M · Авто-генерация диаграмм API** — уровень 3
...
**251 · M · Авто-генерация диаграмм тестового покрытия** — уровень 3
...
**252 · M · Авто-генерация диаграмм Git-истории** — уровень 3
...
**253 · M · Авто-генерация диаграмм CI/CD** — уровень 3
...
**254 · M · Авто-генерация диаграмм P2P-узлов** — уровень 3
...
**255 · M · Авто-генерация диаграмм плагинов** — уровень 3
...
**256 · M · Авто-генерация диаграмм IPC-каналов** — уровень 3
...
**257 · M · Авто-генерация отчёта по архитектуре UI** — уровень 3
...
**258 · M · Авто-генерация отчёта по архитектуре backend** — уровень 3
...
**259 · M · Авто-генерация отчёта по архитектуре агента** — уровень 3
...
**260 · M · Авто-генерация отчёта по архитектуре плагинов** — уровень 3
...
**261 · M · Авто-генерация отчёта по архитектуре интеграций** — уровень 3
...
**262 · M · Авто-генерация отчёта по архитектуре CI/CD** — уровень 3
...
**263 · M · Авто-генерация отчёта по архитектуре P2P** — уровень 3
...
**264 · M · Авто-генерация отчёта по архитектуре RAG** — уровень 3
...
**265 · M · Авто-генерация отчёта по архитектуре символьного индекса** — уровень 3
...
**266 · M · Авто-генерация отчёта по архитектуре worktree** — уровень 3
...
**267 · M · Авто-обнаружение неправильных feature-flags** — уровень 3
...
**268 · M · Авто-обнаружение неправильных путей в RAG-документах** — уровень 3
...
**269 · M · Авто-обнаружение неправильных chunk-размеров RAG** — уровень 3
