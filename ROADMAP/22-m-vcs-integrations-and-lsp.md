...
Пункты 135–179: services.ts, провайдеры, LSP, автоматизации, P2P и диаграммы.

Всего пунктов: 45.

**135 · M · services.ts: файловые операции** — уровень 3
...
**136 · M · services.ts: runCommand** — уровень 3
...
**139 · M · Bitbucket: create_pull_request** — уровень 3
...
**140 · M · Azure DevOps: create_work_item** — уровень 3
...
**141 · M · lspClient — spawn language server** — уровень 3
...
**142 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**143 · M · LSP pyright для Python** — уровень 3
...
**144 · M · Fetch remote skill manifest** — уровень 3
...
**145 · M · import-remote-skill UI** — уровень 3
...
**146 · M · AutomationRule в settings** — уровень 3
...
**147 · M · automationScheduler в main** — уровень 3
...
**148 · M · AutomationsTab в настройках** — уровень 3
...
**149 · M · Дублировать промпт во второй чат** — уровень 3
...
**151 · M · docker-compose для server/p2p** — уровень 3
...
**152 · M · Dashboard статуса узлов** — уровень 3
...
**153 · M · Рейтинг узлов по latency** — уровень 3
...
**157 · M · find_symbol для PHP** — уровень 3
...
**158 · M · find_symbol для Kotlin** — уровень 3
...
**159 · M · find_symbol для Swift** — уровень 3
...
**166 · M · Авто-генерация UML диаграмм** — уровень 3
...
**167 · M · Авто-генерация ER-диаграмм** — уровень 3
...
**168 · M · Авто-генерация sequence-диаграмм** — уровень 3
...
**169 · M · Авто-генерация диаграмм состояний** — уровень 3
...
**170 · M · Авто-генерация архитектурных отчётов** — уровень 3
...
**171 · M · Авто-генерация отчёта по качеству кода** — уровень 3
...
**172 · M · Авто-обнаружение дублирующихся функций** — уровень 3
...
**173 · M · Авто-обнаружение неиспользуемых зависимостей** — уровень 3
...
**174 · M · Авто-обнаружение устаревших API** — уровень 3
...
**175 · M · Авто-обнаружение потенциальных утечек памяти** — уровень 3
...
**176 · M · Авто-обнаружение неправильных async-паттернов** — уровень 3
...
**177 · M · Авто-обнаружение циклов в логике** — уровень 3
...
**178 · M · Авто-обнаружение неэффективных структур данных** — уровень 3
...
**179 · M · Авто-обнаружение неправильных путей в UI** — уровень 3
