...
Пункты 180–224: services.ts, провайдеры, LSP, автоматизации, P2P и диаграммы.

Всего пунктов: 45.

**179 · M · services.ts: файловые операции** — уровень 3
...
**180 · M · services.ts: runCommand** — уровень 3
...
**183 · M · Bitbucket: create_pull_request** — уровень 3
...
**184 · M · Azure DevOps: create_work_item** — уровень 3
...
**185 · M · lspClient — spawn language server** — уровень 3
...
**186 · M · LSP hover и go-to-definition (TS/JS)** — уровень 3
...
**187 · M · LSP pyright для Python** — уровень 3
...
**188 · M · Fetch remote skill manifest** — уровень 3
...
**189 · M · import-remote-skill UI** — уровень 3
...
**190 · M · AutomationRule в settings** — уровень 3
...
**191 · M · automationScheduler в main** — уровень 3
...
**192 · M · AutomationsTab в настройках** — уровень 3
...
**193 · M · Дублировать промпт во второй чат** — уровень 3
...
**195 · M · docker-compose для server/p2p** — уровень 3
...
**196 · M · Dashboard статуса узлов** — уровень 3
...
**197 · M · Рейтинг узлов по latency** — уровень 3
...
**201 · M · find_symbol для PHP** — уровень 3
...
**202 · M · find_symbol для Kotlin** — уровень 3
...
**203 · M · find_symbol для Swift** — уровень 3
...
**210 · M · Авто-генерация UML диаграмм** — уровень 3
...
**211 · M · Авто-генерация ER-диаграмм** — уровень 3
...
**212 · M · Авто-генерация sequence-диаграмм** — уровень 3
...
**213 · M · Авто-генерация диаграмм состояний** — уровень 3
...
**214 · M · Авто-генерация архитектурных отчётов** — уровень 3
...
**215 · M · Авто-генерация отчёта по качеству кода** — уровень 3
...
**216 · M · Авто-обнаружение дублирующихся функций** — уровень 3
...
**217 · M · Авто-обнаружение неиспользуемых зависимостей** — уровень 3
...
**218 · M · Авто-обнаружение устаревших API** — уровень 3
...
**219 · M · Авто-обнаружение потенциальных утечек памяти** — уровень 3
...
**220 · M · Авто-обнаружение неправильных async-паттернов** — уровень 3
...
**221 · M · Авто-обнаружение циклов в логике** — уровень 3
...
**222 · M · Авто-обнаружение неэффективных структур данных** — уровень 3
...
**223 · M · Авто-обнаружение неправильных путей в UI** — уровень 3
