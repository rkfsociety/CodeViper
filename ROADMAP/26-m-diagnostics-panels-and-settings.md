...
Пункты 348–392: Git-диаграммы, LSP для языков, панели и диагностика.

Всего пунктов: 45.

**348 · M · Авто-генерация диаграмм Git-авторов** — уровень 3
...
**349 · M · Авто-генерация диаграмм Git-активности** — уровень 3
...
**350 · M · Авто-генерация диаграмм Git-статистики** — уровень 3
...
**351 · M · Авто-генерация отчёта по качеству тестов** — уровень 3
...
**352 · M · Авто-генерация отчёта по качеству документации** — уровень 3
...
**353 · M · Авто-генерация отчёта по качеству UI** — уровень 3
...
**354 · M · Авто-генерация отчёта по качеству UX** — уровень 3
...
**355 · M · Авто-генерация отчёта по качеству интеграций** — уровень 3
...
**356 · M · Авто-генерация отчёта по качеству плагинов** — уровень 3
...
**357 · M · Авто-генерация отчёта по качеству CI/CD** — уровень 3
...
**358 · M · Авто-генерация отчёта по качеству P2P** — уровень 3
...
**359 · M · Авто-генерация отчёта по качеству RAG** — уровень 3
...
**360 · M · Авто-генерация отчёта по качеству символьного индекса** — уровень 3
...
**361 · M · Авто-обнаружение «тяжёлых» циклов** — уровень 3
...
**362 · M · Авто-обнаружение неправильных try/catch блоков** — уровень 3
...
**363 · M · Авто-обнаружение неправильных async-итераторов** — уровень 3
...
**364 · M · Авто-обнаружение неправильных генераторов** — уровень 3
...
**365 · M · Авто-обнаружение неправильных named-экспортов** — уровень 3
...
**366 · M · Авто-обнаружение неправильных путей в CodeEditorPanel** — уровень 3
...
**367 · M · Авто-обнаружение неправильных путей в ProjectTreePanel** — уровень 3
...
**368 · M · Авто-обнаружение неправильных путей в SettingsModal** — уровень 3
...
**369 · M · Авто-обнаружение неправильных путей в MetricsPanel** — уровень 3
...
**370 · M · Авто-обнаружение неправильных путей в WelcomePanel** — уровень 3
...
**371 · M · Авто-обнаружение неправильных путей в IntegrationsTab** — уровень 3
...
**372 · M · Авто-обнаружение неправильных путей в ModelTab** — уровень 3
...
**373 · M · Авто-обнаружение неправильных путей в PerformanceTab** — уровень 3
...
**374 · M · Авто-обнаружение неправильных путей в MemoryPanel** — уровень 3
...
**375 · M · Авто-обнаружение неправильных путей в AgentStatusBar** — уровень 3
...
**376 · M · Авто-обнаружение неправильных путей в agentLogger** — уровень 3
- **Цель:** проверка логов
...
**377 · M · Авто-обнаружение неправильных путей в agent.ts** — уровень 3
...
**378 · M · Авто-обнаружение неправильных путей в agentTools** — уровень 3
- **Цель:** проверка tools
- **Файлы:** `agentTools/*`
...
**379 · M · Авто-обнаружение неправильных путей в provider-модулях** — уровень 3
...
**380 · M · Авто-обнаружение неправильных путей в fileServices** — уровень 3
...
**381 · M · Авто-обнаружение неправильных путей в preload.ts** — уровень 3
...
**382 · M · find_symbol для Q#** — уровень 3
...
**383 · M · find_symbol для Hack** — уровень 3
...
**384 · M · find_symbol для Mojo** — уровень 3
...
**385 · M · find_symbol для Zig** — уровень 3
...
**386 · M · find_symbol для Red** — уровень 3
...
**387 · M · find_symbol для ReScript** — уровень 3
...
**388 · M · find_symbol для Elm** — уровень 3
...
**389 · M · find_symbol для Futhark** — уровень 3
...
**390 · M · find_symbol для Idris** — уровень 3
...
**391 · M · find_symbol для Mercury** — уровень 3
