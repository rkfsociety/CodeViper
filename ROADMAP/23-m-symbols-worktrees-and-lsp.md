...
Пункты 179–223: IPC/UI-детект, find_symbol, LSP для редких языков.

Всего пунктов: 45.

**179 · M · Авто-обнаружение неправильных IPC вызовов** — уровень 3
...
**180 · M · Авто-обнаружение неправильных настроек** — уровень 3
...
**181 · M · Авто-обнаружение неправильных тем UI** — уровень 3
...
**182 · M · find_symbol для Scala** — уровень 3
...
**183 · M · find_symbol для Elixir** — уровень 3
...
**184 · M · find_symbol для Haskell** — уровень 3
...
**185 · M · find_symbol для OCaml** — уровень 3
...
**186 · M · find_symbol для Lua** — уровень 3
...
**187 · M · find_symbol для Perl** — уровень 3
...
**188 · M · find_symbol для R** — уровень 3
...
**189 · M · find_symbol для MATLAB** — уровень 3
...
**190 · M · find_symbol для Julia** — уровень 3
...
**191 · M · find_symbol для Shell-скриптов** — уровень 3
...
**193 · M · LSP для Elixir** — уровень 3
...
**194 · M · LSP для Haskell** — уровень 3
...
**199 · M · LSP для MATLAB** — уровень 3
...
**201 · M · LSP для Shell-скриптов** — уровень 3
...
**202 · M · Авто-оптимизация импортов** — уровень 3
...
**203 · M · Авто-обнаружение неправильных путей в тестах** — уровень 3
...
**204 · M · Авто-обнаружение неправильных типов в UI** — уровень 3
...
**205 · M · Авто-обнаружение неправильных ключей React** — уровень 3
...
**206 · M · Авто-обнаружение неправильных зависимостей useEffect** — уровень 3
...
**207 · M · Авто-обнаружение неправильных IPC-ответов** — уровень 3
...
**208 · M · Авто-обнаружение неправильных тем в CSS** — уровень 3
...
**209 · M · Авто-обнаружение неправильных шрифтов** — уровень 3
...
**210 · M · Авто-обнаружение неправильных hotkeys в модалках** — уровень 3
...
**211 · M · Авто-обнаружение неправильных размеров файлов** — уровень 3
...
**212 · M · Авто-обнаружение неправильных токенов интеграций** — уровень 3
...
**213 · M · Авто-обнаружение неправильных worktree путей** — уровень 3
...
**214 · M · Авто-обнаружение неправильных веток Git** — уровень 3
...
**215 · M · Авто-обнаружение неправильных PR описаний** — уровень 3
...
**216 · M · Авто-обнаружение неправильных веток CI** — уровень 3
...
**217 · M · Авто-обнаружение неправильных зависимостей CI** — уровень 3
...
**218 · M · Авто-обнаружение неправильных Docker-volumes** — уровень 3
...
**219 · M · Авто-обнаружение неправильных P2P-узлов** — уровень 3
- **Цель:** проверка узлов
...
**220 · M · Авто-обнаружение неправильных P2P-маршрутов** — уровень 3
...
**221 · M · Авто-обнаружение неправильных плагинов** — уровень 3
...
**222 · M · Авто-обнаружение неправильных RAG-индексов** — уровень 3
...
**223 · M · Авто-обнаружение неправильных fallback-моделей** — уровень 3
