...
Пункты 393–437: LSP, BehaviorTab, ModelTab и голосовой UI.

Всего пунктов: 45.

**393 · M · LSP для Hack** — уровень 3
...
**397 · M · LSP для ReScript** — уровень 3
...
**399 · M · LSP для Futhark** — уровень 3
...
**401 · M · LSP для Mercury** — уровень 3
...
**402 · M · Авто-генерация диаграмм потоков данных UI** — уровень 3
...
**403 · M · Авто-генерация диаграмм потоков данных backend** — уровень 3
...
**404 · M · Авто-генерация диаграмм потоков данных агента** — уровень 3
...
**405 · M · Авто-генерация диаграмм потоков данных плагинов** — уровень 3
...
**406 · M · Авто-генерация диаграмм потоков данных RAG** — уровень 3
...
**407 · M · Авто-генерация диаграмм потоков данных P2P** — уровень 3
...
**408 · M · Авто-генерация диаграмм потоков данных CI/CD** — уровень 3
...
**409 · M · Авто-генерация диаграмм потоков данных worktree** — уровень 3
...
**410 · M · Авто-генерация диаграмм потоков данных IPC** — уровень 3
...
**411 · M · Авто-генерация диаграмм потоков данных settings** — уровень 3
...
**412 · M · Авто-генерация отчёта по качеству архитектуры UI** — уровень 3
...
**413 · M · Авто-генерация отчёта по качеству архитектуры backend** — уровень 3
...
**414 · M · Авто-генерация отчёта по качеству архитектуры агента** — уровень 3
...
**415 · M · Авто-генерация отчёта по качеству архитектуры плагинов** — уровень 3
...
**416 · M · Авто-генерация отчёта по качеству архитектуры RAG** — уровень 3
...
**417 · M · Авто-генерация отчёта по качеству архитектуры P2P** — уровень 3
...
**418 · M · Авто-генерация отчёта по качеству архитектуры CI/CD** — уровень 3
...
**419 · M · Авто-генерация отчёта по качеству архитектуры worktree** — уровень 3
...
**420 · M · Авто-генерация отчёта по качеству архитектуры IPC** — уровень 3
...
**421 · M · Авто-генерация отчёта по качеству архитектуры settings** — уровень 3
...
**422 · M · STT — кнопка микрофона** — уровень 4
...
**423 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**424 · M · Разбивка App.tsx** — уровень 4
...
**425 · M · Разбивка agent.ts** — уровень 4
...
**426 · M · Хук useChatPanelState** — уровень 4
...
**427 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**428 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**429 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**430 · M · types.ts: доменные модули** — уровень 4
...
**431 · M · agentContext: RAG-hints** — уровень 4
...
**432 · M · agentContext: preview и prepare** — уровень 4
...
**433 · M · useAgentStream: обработчики событий** — уровень 4
...
**434 · M · preload: группы API** — уровень 4
...
**435 · M · agentTools/core: files / git / package** — уровень 4
...
**436 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**437 · M · BehaviorTab: инструменты и промпты** — уровень 4
