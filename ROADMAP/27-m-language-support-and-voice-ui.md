...
Пункты 361–405: LSP, BehaviorTab, ModelTab и голосовой UI.

Всего пунктов: 45.

**361 · M · LSP для Hack** — уровень 3
...
**365 · M · LSP для ReScript** — уровень 3
...
**367 · M · LSP для Futhark** — уровень 3
...
**369 · M · LSP для Mercury** — уровень 3
...
**370 · M · Авто-генерация диаграмм потоков данных UI** — уровень 3
...
**371 · M · Авто-генерация диаграмм потоков данных backend** — уровень 3
...
**372 · M · Авто-генерация диаграмм потоков данных агента** — уровень 3
...
**373 · M · Авто-генерация диаграмм потоков данных плагинов** — уровень 3
...
**374 · M · Авто-генерация диаграмм потоков данных RAG** — уровень 3
...
**375 · M · Авто-генерация диаграмм потоков данных P2P** — уровень 3
...
**376 · M · Авто-генерация диаграмм потоков данных CI/CD** — уровень 3
...
**377 · M · Авто-генерация диаграмм потоков данных worktree** — уровень 3
...
**378 · M · Авто-генерация диаграмм потоков данных IPC** — уровень 3
...
**379 · M · Авто-генерация диаграмм потоков данных settings** — уровень 3
...
**380 · M · Авто-генерация отчёта по качеству архитектуры UI** — уровень 3
...
**381 · M · Авто-генерация отчёта по качеству архитектуры backend** — уровень 3
...
**382 · M · Авто-генерация отчёта по качеству архитектуры агента** — уровень 3
...
**383 · M · Авто-генерация отчёта по качеству архитектуры плагинов** — уровень 3
...
**384 · M · Авто-генерация отчёта по качеству архитектуры RAG** — уровень 3
...
**385 · M · Авто-генерация отчёта по качеству архитектуры P2P** — уровень 3
...
**386 · M · Авто-генерация отчёта по качеству архитектуры CI/CD** — уровень 3
...
**387 · M · Авто-генерация отчёта по качеству архитектуры worktree** — уровень 3
...
**388 · M · Авто-генерация отчёта по качеству архитектуры IPC** — уровень 3
...
**389 · M · Авто-генерация отчёта по качеству архитектуры settings** — уровень 3
...
**390 · M · STT — кнопка микрофона** — уровень 4
...
**391 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**392 · M · Разбивка App.tsx** — уровень 4
...
**393 · M · Разбивка agent.ts** — уровень 4
...
**394 · M · Хук useChatPanelState** — уровень 4
...
**395 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**396 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**397 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**398 · M · types.ts: доменные модули** — уровень 4
...
**399 · M · agentContext: RAG-hints** — уровень 4
...
**400 · M · agentContext: preview и prepare** — уровень 4
...
**401 · M · useAgentStream: обработчики событий** — уровень 4
...
**402 · M · preload: группы API** — уровень 4
...
**403 · M · agentTools/core: files / git / package** — уровень 4
...
**404 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**405 · M · BehaviorTab: инструменты и промпты** — уровень 4
