...
Пункты 405–449: LSP, BehaviorTab, ModelTab и голосовой UI.

Всего пунктов: 45.

**404 · M · LSP для Hack** — уровень 3
...
**408 · M · LSP для ReScript** — уровень 3
...
**410 · M · LSP для Futhark** — уровень 3
...
**412 · M · LSP для Mercury** — уровень 3
...
**413 · M · Авто-генерация диаграмм потоков данных UI** — уровень 3
...
**414 · M · Авто-генерация диаграмм потоков данных backend** — уровень 3
...
**415 · M · Авто-генерация диаграмм потоков данных агента** — уровень 3
...
**416 · M · Авто-генерация диаграмм потоков данных плагинов** — уровень 3
...
**417 · M · Авто-генерация диаграмм потоков данных RAG** — уровень 3
...
**418 · M · Авто-генерация диаграмм потоков данных P2P** — уровень 3
...
**419 · M · Авто-генерация диаграмм потоков данных CI/CD** — уровень 3
...
**420 · M · Авто-генерация диаграмм потоков данных worktree** — уровень 3
...
**421 · M · Авто-генерация диаграмм потоков данных IPC** — уровень 3
...
**422 · M · Авто-генерация диаграмм потоков данных settings** — уровень 3
...
**423 · M · Авто-генерация отчёта по качеству архитектуры UI** — уровень 3
...
**424 · M · Авто-генерация отчёта по качеству архитектуры backend** — уровень 3
...
**425 · M · Авто-генерация отчёта по качеству архитектуры агента** — уровень 3
...
**426 · M · Авто-генерация отчёта по качеству архитектуры плагинов** — уровень 3
...
**427 · M · Авто-генерация отчёта по качеству архитектуры RAG** — уровень 3
...
**428 · M · Авто-генерация отчёта по качеству архитектуры P2P** — уровень 3
...
**429 · M · Авто-генерация отчёта по качеству архитектуры CI/CD** — уровень 3
...
**430 · M · Авто-генерация отчёта по качеству архитектуры worktree** — уровень 3
...
**431 · M · Авто-генерация отчёта по качеству архитектуры IPC** — уровень 3
...
**432 · M · Авто-генерация отчёта по качеству архитектуры settings** — уровень 3
...
**433 · M · STT — кнопка микрофона** — уровень 4
...
**434 · M · TTS — кнопка «Озвучить»** — уровень 4
...
**435 · M · Разбивка App.tsx** — уровень 4
...
**436 · M · Разбивка agent.ts** — уровень 4
...
**437 · M · Хук useChatPanelState** — уровень 4
...
**438 · M · ChatPanel: вынести MessagesPane state** — уровень 4
...
**439 · M · ChatHistoryPanel: виртуализированный список** — уровень 4
...
**440 · M · ChatHistoryPanel: DnD и диалоги** — уровень 4
...
**441 · M · types.ts: доменные модули** — уровень 4
...
**442 · M · agentContext: RAG-hints** — уровень 4
...
**443 · M · agentContext: preview и prepare** — уровень 4
...
**444 · M · useAgentStream: обработчики событий** — уровень 4
...
**445 · M · preload: группы API** — уровень 4
...
**446 · M · agentTools/core: files / git / package** — уровень 4
...
**447 · M · BehaviorTab: автоматизация и git** — уровень 4
...
**448 · M · BehaviorTab: инструменты и промпты** — уровень 4
