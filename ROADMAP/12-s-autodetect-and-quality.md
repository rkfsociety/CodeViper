...
Пункты 16–44: авто-обнаружение проблем в настройках, тестах и инфраструктуре.

Всего пунктов: 29.

**16 · S · Tool `find_collective_memory_issues`** — уровень 3
...
**17 · S · Tool `find_chat_template_issues`** — уровень 3
...
**18 · S · Tool `find_split_layout_issues`** — уровень 3
...
**19 · S · Tool `find_quick_open_issues`** — уровень 3
...
**20 · S · Tool `find_code_editor_issues`** — уровень 3
...
**21 · S · Tool `find_mcp_server_issues`** — уровень 3
...
**22 · S · Tool `find_enabled_tools_issues`** — уровень 3
...
**23 · S · Tool `find_tool_description_issues`** — уровень 3
...
**24 · S · Tool `find_tool_param_issues`** — уровень 3
...
**25 · S · Tool `find_tool_error_issues`** — уровень 3
...
**26 · S · Tool `find_tool_fallback_issues`** — уровень 3
...
**27 · S · Tool `find_switch_issues`** — уровень 3
...
**28 · S · Tool `find_throw_issues`** — уровень 3
...
**29 · S · Tool `find_default_export_issues`** — уровень 3
...
**30 · S · Tool `find_import_alias_issues`** — уровень 3
...
**31 · S · Tool `find_hardcoded_path_issues`** — уровень 3
...
**32 · S · Режим высокой контрастности** — уровень 4
...
**33 · S · Цвет папки чатов** — уровень 4
...
**34 · S · Фильтр по тегам в SkillsPanel** — уровень 4
...
**35 · S · Сохранение последнего benchmark** — уровень 4
...
**36 · S · Long paths на Windows** — уровень 4
...
**37 · S · Авто-озвучка ошибок агента** — уровень 4
...
**38 · S · Авто-озвучка успешного завершения** — уровень 4
...
**39 · S · Tool `publish_docker_image`** — уровень 4
...
**40 · S · Tool `deploy_vercel` / `deploy_netlify`** — уровень 4
...
**41 · S · Tool `generate_helm_chart`** — уровень 4
...
**42 · S · Tool `generate_ansible_role`** — уровень 4
...
**43 · S · Tool `generate_github_actions`** — уровень 4
...
**44 · S · Tool `generate_gitlab_ci`** — уровень 4
