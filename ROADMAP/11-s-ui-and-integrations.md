...
**2 · S · Tool `find_prompt_template_issues`**
...
**3 · S · Tool `find_toast_a11y_issues`**
...
**5 · S · Tool `find_rag_model_issues`**
...
**6 · S · Tool `find_index_param_issues`**
...
**7 · S · Tool `find_orchestrator_issues`**
...
**8 · S · Tool `find_vision_model_issues`**
...
**9 · S · Tool `find_explorer_subagent_issues`**
...
**10 · S · Tool `find_reviewer_subagent_issues`**
...
**11 · S · Tool `find_architect_subagent_issues`**
...
**12 · S · Tool `find_performance_subagent_issues`**
...
**13 · S · Tool `find_settings_path_issues`**
