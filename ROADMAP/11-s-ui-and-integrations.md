...
Пункты 1–44: интерфейс, webhooks, P2P, метрики и интеграции.

Всего пунктов: 42.

**1 · S · Экспорт метрик в CSV** — уровень 3
...
**3 · S · Telegram Bot уведомления** — уровень 3
...
**8 · S · Авто-генерация диаграмм зависимостей** — уровень 3
...
**9 · S · Авто-генерация диаграмм классов** — уровень 3
...
**10 · S · Авто-генерация диаграмм потоков данных** — уровень 3
...
**11 · S · Авто-генерация метрик проекта** — уровень 3
...
**12 · S · Авто-обнаружение «мертвого кода»** — уровень 3
...
**13 · S · Авто-обнаружение «магических чисел»** — уровень 3
...
**14 · S · Авто-обнаружение небезопасных регулярных выражений** — уровень 3
...
**15 · S · Авто-обнаружение неправильных типов** — уровень 3
...
**16 · S · Авто-обнаружение неправильных импортов** — уровень 3
...
**17 · S · Авто-обнаружение неправильных hotkeys** — уровень 3
...
**18 · S · Авто-обнаружение «тяжёлых» зависимостей** — уровень 3
...
**19 · S · Авто-обнаружение пропущенных тестов** — уровень 3
...
**20 · S · Авто-обнаружение лишних ререндеров** — уровень 3
...
**21 · S · Авто-обнаружение неправильных путей в settings.json** — уровень 3
...
**22 · S · Авто-обнаружение неправильных aria-атрибутов** — уровень 3
...
**23 · S · Авто-обнаружение неправильных путей в интеграциях** — уровень 3
...
**24 · S · Авто-обнаружение неправильных cron-выражений** — уровень 3
...
**25 · S · Авто-обнаружение неправильных merge-конфликтов** — уровень 3
- **Цель:** поиск `<<<<<<<`
...
**26 · S · Авто-обнаружение неправильных commit-сообщений** — уровень 3
...
**27 · S · Авто-обнаружение неправильных Docker-портов** — уровень 3
...
**28 · S · Авто-обнаружение неправильных Docker-env** — уровень 3
- **Цель:** проверка env
- **Файлы:** `.env`
- **Действие:** анализ
- **Проверка:** отчёт
...
**29 · S · Авто-обнаружение неправильных P2P-кредитов** — уровень 3
...
**30 · S · Авто-обнаружение неправильных P2P-подключений** — уровень 3
- **Цель:** проверка WSS
- **Файлы:** `p2pClient.ts`
- **Действие:** анализ
- **Проверка:** отчёт
...
**31 · S · Авто-обнаружение неправильных skill-файлов** — уровень 3
...
**32 · S · Авто-обнаружение неправильных символьных индексов** — уровень 3
...
**33 · S · Авто-обнаружение неправильных prompt-templates** — уровень 3
...
**34 · S · Авто-обнаружение неправильных toast-уведомлений** — уровень 3
...
**35 · S · Авто-обнаружение неправильных environment-переменных** — уровень 3
- **Цель:** проверка `.env`
...
**36 · S · Авто-обнаружение неправильных моделей RAG** — уровень 3
...
**37 · S · Авто-обнаружение неправильных параметров индексации** — уровень 3
...
**38 · S · Авто-обнаружение неправильных настроек orchestrator** — уровень 3
...
**39 · S · Авто-обнаружение неправильных настроек Vision-моделей** — уровень 3
...
**40 · S · Авто-обнаружение неправильных настроек Explorer-субагента** — уровень 3
...
**41 · S · Авто-обнаружение неправильных настроек Reviewer-субагента** — уровень 3
...
**42 · S · Авто-обнаружение неправильных настроек Architect-субагента** — уровень 3
...
**43 · S · Авто-обнаружение неправильных настроек Performance-субагента** — уровень 3
