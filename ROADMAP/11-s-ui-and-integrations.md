...
**8 · S · Tool `find_merge_conflicts`** — уровень 3
...
**8 · S · Tool `find_commit_message_issues`** — уровень 3
...
**9 · S · Tool `find_docker_port_issues`** — уровень 3
...
**10 · S · Tool `find_docker_env_issues`** — уровень 3
...
**11 · S · Tool `find_p2p_credit_issues`** — уровень 3
...
**12 · S · Tool `find_p2p_connection_issues`** — уровень 3
...
**13 · S · Tool `find_skill_file_issues`** — уровень 3
...
**14 · S · Tool `find_symbol_index_issues`** — уровень 3
...
**15 · S · Tool `find_prompt_template_issues`** — уровень 3
...
**16 · S · Tool `find_toast_a11y_issues`** — уровень 3
...
**17 · S · Tool `find_env_issues`** — уровень 3
...
**18 · S · Tool `find_rag_model_issues`** — уровень 3
...
**19 · S · Tool `find_index_param_issues`** — уровень 3
...
**20 · S · Tool `find_orchestrator_issues`** — уровень 3
...
**21 · S · Tool `find_vision_model_issues`** — уровень 3
...
**22 · S · Tool `find_explorer_subagent_issues`** — уровень 3
...
**23 · S · Tool `find_reviewer_subagent_issues`** — уровень 3
...
**24 · S · Tool `find_architect_subagent_issues`** — уровень 3
...
**25 · S · Tool `find_performance_subagent_issues`** — уровень 3
