...
Пункты 1–16: интерфейс, webhooks, P2P, метрики и интеграции.

Всего пунктов: 16.

**1 · S · Tool `find_docker_port_issues`**
...
**2 · S · Tool `find_docker_env_issues`**
...
**3 · S · Tool `find_p2p_credit_issues`**
...
**4 · S · Tool `find_symbol_index_issues`**
...
**5 · S · Tool `find_prompt_template_issues`**
...
**6 · S · Tool `find_toast_a11y_issues`**
...
**8 · S · Tool `find_rag_model_issues`**
...
**9 · S · Tool `find_index_param_issues`**
...
**10 · S · Tool `find_orchestrator_issues`**
...
**11 · S · Tool `find_vision_model_issues`**
...
**12 · S · Tool `find_explorer_subagent_issues`**
...
**13 · S · Tool `find_reviewer_subagent_issues`**
...
**14 · S · Tool `find_architect_subagent_issues`**
...
**15 · S · Tool `find_performance_subagent_issues`**
...
**16 · S · Tool `find_settings_path_issues`**
