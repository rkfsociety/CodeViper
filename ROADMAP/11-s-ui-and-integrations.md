...
**17 · S · Tool `find_vision_model_issues`**
...
**18 · S · Tool `find_explorer_subagent_issues`**
...
**19 · S · Tool `find_reviewer_subagent_issues`**
...
**20 · S · Tool `find_architect_subagent_issues`**
...
**21 · S · Tool `find_performance_subagent_issues`**
...
**22 · S · Tool `find_settings_path_issues`**
