...
**9 · S · Tool `find_prompt_template_issues`**
...
**10 · S · Tool `find_toast_a11y_issues`**
...
**12 · S · Tool `find_rag_model_issues`**
...
**13 · S · Tool `find_index_param_issues`**
...
**14 · S · Tool `find_orchestrator_issues`**
...
**15 · S · Tool `find_vision_model_issues`**
...
**16 · S · Tool `find_explorer_subagent_issues`**
...
**17 · S · Tool `find_reviewer_subagent_issues`**
...
**18 · S · Tool `find_architect_subagent_issues`**
...
**19 · S · Tool `find_performance_subagent_issues`**
