...
**460 · M · Mermaid в ответах агента** — уровень 4
...
**465 · M · Переключатель языка в настройках** — уровень 4
...
**466 · M · i18n: строки App и шапки** — уровень 4
...
**467 · M · i18n: SettingsModal** — уровень 4
...
**468 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**469 · M · Docker dev-окружение** — уровень 4
...
**470 · M · STT улучшенный режим (VAD + шумоподавление)** — уровень 4
...
**471 · M · TTS с выбором голоса** — уровень 4
...
**472 · M · Docker-режим для агента** — уровень 4
...
**473 · M · Авто-сборка Docker-образов проекта** — уровень 4
...
**474 · M · Авто-деплой на сервер** — уровень 4
...
**475 · M · Авто-деплой на Kubernetes** — уровень 4
...
**476 · M · Авто-генерация Terraform-конфигов** — уровень 4
...
**477 · M · Авто-генерация CI/CD pipelines** — уровень 4
...
**478 · M · Авто-генерация release-notes** — уровень 4
...
**479 · M · Авто-генерация аудио-версии README** — уровень 4
...
**480 · M · Авто-генерация видео-обзора проекта** — уровень 4
...
**481 · M · Авто-генерация UI-скриншотов** — уровень 4
...
**482 · M · Авто-генерация UX-отчётов** — уровень 4
...
**483 · M · Авто-генерация цветовых тем** — уровень 4
...
**484 · M · Авто-генерация логотипов** — уровень 4
...
**485 · M · Авто-генерация маркетинговых материалов** — уровень 4
...
**486 · M · Авто-генерация документации для плагинов** — уровень 4
...
**487 · M · Авто-генерация обучающих материалов** — уровень 4
...
**488 · M · Авто-генерация руководства пользователя** — уровень 4
...
**489 · M · Авто-генерация видео-гайдов** — уровень 4
...
**490 · M · Авто-генерация видео-демонстраций UI** — уровень 4
...
**491 · M · Авто-генерация маркетинговых видео** — уровень 4
...
**492 · M · Авто-генерация тем оформления** — уровень 4
...
**493 · M · Авто-генерация UX-гайдов** — уровень 4
