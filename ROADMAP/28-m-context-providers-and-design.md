...
**417 · M · Mermaid в ответах агента** — уровень 4
...
**422 · M · Переключатель языка в настройках** — уровень 4
...
**423 · M · i18n: строки App и шапки** — уровень 4
...
**424 · M · i18n: SettingsModal** — уровень 4
...
**425 · M · i18n: ChatPanel и сообщения UI** — уровень 4
...
**426 · M · Docker dev-окружение** — уровень 4
...
**427 · M · STT улучшенный режим (VAD + шумоподавление)** — уровень 4
...
**428 · M · TTS с выбором голоса** — уровень 4
...
**429 · M · Docker-режим для агента** — уровень 4
...
**430 · M · Авто-сборка Docker-образов проекта** — уровень 4
...
**431 · M · Авто-деплой на сервер** — уровень 4
...
**432 · M · Авто-деплой на Kubernetes** — уровень 4
...
**433 · M · Авто-генерация Terraform-конфигов** — уровень 4
...
**434 · M · Авто-генерация CI/CD pipelines** — уровень 4
...
**435 · M · Авто-генерация release-notes** — уровень 4
...
**436 · M · Авто-генерация аудио-версии README** — уровень 4
...
**437 · M · Авто-генерация видео-обзора проекта** — уровень 4
...
**438 · M · Авто-генерация UI-скриншотов** — уровень 4
...
**439 · M · Авто-генерация UX-отчётов** — уровень 4
...
**440 · M · Авто-генерация цветовых тем** — уровень 4
...
**441 · M · Авто-генерация логотипов** — уровень 4
...
**442 · M · Авто-генерация маркетинговых материалов** — уровень 4
...
**443 · M · Авто-генерация документации для плагинов** — уровень 4
...
**444 · M · Авто-генерация обучающих материалов** — уровень 4
...
**445 · M · Авто-генерация руководства пользователя** — уровень 4
...
**446 · M · Авто-генерация видео-гайдов** — уровень 4
...
**447 · M · Авто-генерация видео-демонстраций UI** — уровень 4
...
**448 · M · Авто-генерация маркетинговых видео** — уровень 4
...
**449 · M · Авто-генерация тем оформления** — уровень 4
...
**450 · M · Авто-генерация UX-гайдов** — уровень 4
