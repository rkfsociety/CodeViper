...
Пункты 91–135: модалки, логи, субагенты, git, worktree и контракты IPC.

Всего пунктов: 45.

**91 · M · Аудит focus trap в модалках** — уровень 2
...
**92 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**93 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**94 · M · Субагент Reviewer** — уровень 2
...
**95 · M · Субагент Tester** — уровень 2
...
**96 · M · git_blame и git_show** — уровень 2
...
**99 · M · npm_install / add_package** — уровень 2
...
**100 · M · E2E: smoke настройки и отправка** — уровень 2
...
**101 · M · Component test MessageRow** — уровень 2
...
**102 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`
- **Проверка:** `npm run test:e2e`


**103 · M · ModelTab: формы провайдеров** — уровень 2
...
**104 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**105 · M · Экспорт чата в Markdown** — уровень 2
...
**106 · M · IPC export-chat** — уровень 2
...
**107 · M · IPC import-chat** — уровень 2
...
**108 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**109 · M · Сохранение из редактора** — уровень 2
...
**110 · M · Subagent Architect — анализ структуры проекта** — уровень 2
...
**111 · M · Subagent Documenter — генерация документации** — уровень 2
...
**112 · M · Subagent Security — поиск секретов и unsafe команд** — уровень 2
...
**113 · M · Авто-генерация новых пунктов ROADMAP** — уровень 2
...
**114 · M · Self-Improvement Queue Panel** — уровень 2
...
**115 · M · Авто-цепочки задач** — уровень 2
...
**116 · M · Граф архитектуры проекта** — уровень 2
...
**117 · M · Авто-генерация тестов для новых файлов** — уровень 2
...
**118 · M · Авто-документирование новых функций** — уровень 2
...
**119 · M · Авто-оптимизация больших файлов** — уровень 2
...
**120 · M · Авто-обновление зависимостей** — уровень 2
...
**121 · M · Авто-генерация CHANGELOG** — уровень 2
...
**122 · M · Авто-проверка лицензий** — уровень 2
...
**123 · M · Subagent Refactorer — автоматический рефакторинг** — уровень 2
...
**124 · M · Авто-генерация Roadmap Chains** — уровень 2
...
**125 · M · Subagent Performance — анализ производительности проекта** — уровень 2
...
**126 · M · Subagent Compliance — проверка соответствия стандартам** — уровень 2
...
**127 · M · Subagent Referee — сравнение двух решений** — уровень 2
...
**128 · M · find_symbol для Go** — уровень 3
...
**129 · M · find_symbol для Rust** — уровень 3
...
**130 · M · find_symbol для Java** — уровень 3
...
**131 · M · gitWorktree.ts** — уровень 3
...
**132 · M · worktreePath в чате + IPC** — уровень 3
...
**133 · M · AgentRunner — корень worktree** — уровень 3
...
**134 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**135 · M · ipcContracts: IPC enum и Contracts** — уровень 3
