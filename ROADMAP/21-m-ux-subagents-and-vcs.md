# M: UX, субагенты, git и IPC

Пункты 123–167: модалки, логи, субагенты, git, worktree и контракты IPC.

Всего пунктов: 45.

**123 · M · Аудит focus trap в модалках** — уровень 2
...
**124 · M · Просмотр NDJSON-логов агента** — уровень 2
...
**125 · M · Клик по пути в code block → открыть файл** — уровень 2
...
**126 · M · Субагент Reviewer** — уровень 2
...
**127 · M · Субагент Tester** — уровень 2
...
**128 · M · git_blame и git_show** — уровень 2
...
**130 · M · read_agent_log** — уровень 2
...
**131 · M · npm_install / add_package** — уровень 2
...
**132 · M · E2E: smoke настройки и отправка** — уровень 2
...
**133 · M · Component test MessageRow** — уровень 2
...
**134 · M · E2E: навигация по вкладкам настроек** — уровень 2
- **Файлы:** `e2e/settings.test.ts`
- **Проверка:** `npm run test:e2e`


**135 · M · ModelTab: формы провайдеров** — уровень 2
...
**136 · M · ModelTab: оркестратор, бенчмарк, канал обновлений** — уровень 2
...
**137 · M · Экспорт чата в Markdown** — уровень 2
...
**138 · M · IPC export-chat** — уровень 2
...
**139 · M · IPC import-chat** — уровень 2
...
**140 · M · CodeEditorPanel на CodeMirror** — уровень 2
...
**141 · M · Сохранение из редактора** — уровень 2
...
**142 · M · Subagent Architect — анализ структуры проекта** — уровень 2
...
**143 · M · Subagent Documenter — генерация документации** — уровень 2
...
**144 · M · Subagent Security — поиск секретов и unsafe команд** — уровень 2
...
**145 · M · Авто-генерация новых пунктов ROADMAP** — уровень 2
...
**146 · M · Self-Improvement Queue Panel** — уровень 2
...
**147 · M · Авто-цепочки задач** — уровень 2
...
**148 · M · Граф архитектуры проекта** — уровень 2
...
**149 · M · Авто-генерация тестов для новых файлов** — уровень 2
...
**150 · M · Авто-документирование новых функций** — уровень 2
...
**151 · M · Авто-оптимизация больших файлов** — уровень 2
...
**152 · M · Авто-обновление зависимостей** — уровень 2
...
**153 · M · Авто-генерация CHANGELOG** — уровень 2
...
**154 · M · Авто-проверка лицензий** — уровень 2
...
**155 · M · Subagent Refactorer — автоматический рефакторинг** — уровень 2
...
**156 · M · Авто-генерация Roadmap Chains** — уровень 2
...
**157 · M · Subagent Performance — анализ производительности проекта** — уровень 2
...
**158 · M · Subagent Compliance — проверка соответствия стандартам** — уровень 2
...
**159 · M · Subagent Referee — сравнение двух решений** — уровень 2
...
**160 · M · find_symbol для Go** — уровень 3
...
**161 · M · find_symbol для Rust** — уровень 3
...
**162 · M · find_symbol для Java** — уровень 3
...
**163 · M · gitWorktree.ts** — уровень 3
...
**164 · M · worktreePath в чате + IPC** — уровень 3
...
**165 · M · AgentRunner — корень worktree** — уровень 3
...
**166 · M · ipcContracts: Zod-схемы данных** — уровень 3
...
**167 · M · ipcContracts: IPC enum и Contracts** — уровень 3
